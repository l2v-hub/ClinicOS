...
test('therapy slots are loaded only when the therapy page is visible, including history navigation', () => {
  assert.match(app, /navKey !== 'terapie'[\s\S]*void loadTherapySlots\(\)/);
