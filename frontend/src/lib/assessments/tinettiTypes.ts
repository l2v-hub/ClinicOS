...
export type TinettiItemId = keyof typeof TINETTI_MAXIMUM;
export type TinettiScore = 0 | 1 | 2;
export type TinettiAnswers = {
  [K in TinettiItemId]: (typeof TINETTI_MAXIMUM)[K] extends 1 ? 0 | 1 | null : TinettiScore | null;
} & { notes: string };
