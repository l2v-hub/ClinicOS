...
export const MOCK_OPERATORI: Operatore[] = [
  {
    ...
    cognome: 'Ferretti',
    ruolo: 'medico',
    email: 'marco.ferretti@clinicos.it',
    telefono: '+39 02 1234 5678',
    reparto: 'Cardiologia',
    stato: 'attivo',
    pazientiAssegnati: 12,
    appuntamentiOggi: 5,
    iniziali: 'MF',
    colore: '#2F6BED',
  ...
  },
  {
    ...
    cognome: 'Moretti',
    ruolo: 'medico',
    email: 'sofia.moretti@clinicos.it',
  ...
  },
  {
    ...
    cognome: 'Bianchi',
    ruolo: 'infermiere',
    email: 'giulia.bianchi@clinicos.it',
    telefono: '+39 02 1234 5680',
    reparto: 'Reparto Generale',
    stato: 'attivo',
    pazientiAssegnati: 15,
    appuntamentiOggi: 7,
    iniziali: 'GB',
    colore: '#6C4BD1',
  },
  {
    ...
    cognome: 'Esposito',
    ruolo: 'infermiere',
    email: 'luca.esposito@clinicos.it',
    telefono: '+39 02 1234 5681',
    reparto: 'Pronto Soccorso',
    stato: 'attivo',
    pazientiAssegnati: 10,
    appuntamentiOggi: 3,
    iniziali: 'LE',
    colore: '#C77700',
  },
  {
    ...
    cognome: 'Ricci',
    ruolo: 'coordinatore',
    email: 'alessandro.ricci@clinicos.it',
    telefono: '+39 02 1234 5682',
    reparto: 'Oncologia',
    stato: 'inattivo',
    pazientiAssegnati: 0,
    appuntamentiOggi: 0,
...
export const MOCK_CONSEGNE: Consegna[] = [
  {
    ...
    scadenza: today(),
    oraScadenza: '08:00',
    operatoreAssegnato: 'Giulia Bianchi',
  ...
  },
  {
    ...
    scadenza: today(),
    oraScadenza: '14:00',
    operatoreAssegnato: 'Luca Esposito',
    creatoDA: 'Dr.ssa Sofia Moretti',
    createdAt: today() + 'T07:00:00',
  },
  {
    id: 'c3',
    pazienteId: '',
    pazienteNome: 'Verdi, Luigi',
    priorita: 'normale',
    stato: 'in_corso',
    tipo: 'Esami',
    ...
    scadenza: today(),
    oraScadenza: '16:00',
    operatoreAssegnato: 'Dr. Marco Ferretti',
    creatoDA: 'Dr.ssa Sofia Moretti',
  ...
  },
  {
    ...
    oraScadenza: '11:00',
    operatoreAssegnato: 'Dr. Marco Ferretti',
    creatoDA: 'Luca Esposito',
    createdAt: today() + 'T10:00:00',
  },
  {
    id: 'c7',
    pazienteId: '',
    pazienteNome: 'Romano, Marco',
    priorita: 'normale',
    stato: 'aperta',
    tipo: 'Rivalutazione',
    ...
    scadenza: today(1),
    oraScadenza: '09:00',
    operatoreAssegnato: 'Dr.ssa Sofia Moretti',
    creatoDA: 'Dr. Marco Ferretti',
...
export const MOCK_AGENDA: SlotAgenda[] = [
  {
    id: 'a1',
    ora: '08:30',
    pazienteNome: 'García, María',
    motivo: 'Controllo post-operatorio',
    stato: 'completato',
    operatoreId: 'op1',
  },
  {
    id: 'a2',
    ora: '09:00',
    pazienteNome: 'López, Carlos',
    motivo: 'Revisione ipertensione',
    stato: 'completato',
    operatoreId: 'op1',
  },
  {
    id: 'a3',
    ora: '09:30',
    pazienteNome: 'Martínez, Ana',
    motivo: 'Visita annuale',
    stato: 'in_corso',
    operatoreId: 'op1',
  },
  {
    id: 'a4',
    ora: '10:30',
    pazienteNome: 'Rodríguez, Juan',
    motivo: 'Valutazione dolore toracico',
    stato: 'programmato',
    operatoreId: 'op1',
  },
  { id: 'a5', ora: '11:00', pazienteNome: null, motivo: '', stato: 'libero' },
  {
    id: 'a6',
    ora: '14:00',
    pazienteNome: 'Sánchez, Elena',
    motivo: 'Gestione diabete',
    stato: 'programmato',
    operatoreId: 'op1',
  },
  {
    id: 'a7',
    ora: '15:30',
    pazienteNome: 'Torres, Miguel',
    motivo: 'ECG + Risultati analisi',
    stato: 'programmato',
    operatoreId: 'op2',
  },
];
...
export const MOCK_APPUNTAMENTI: Appuntamento[] = [
  {
    ...
    pazienteNome: 'García, María',
    operatoreId: 'op1',
    operatoreNome: 'Ferretti Marco',
    tipoIntervento: 'controllo',
    stato: 'completato',
    priorita: 'normale',
  ...
  },
  {
    ...
    pazienteNome: 'Rossi, Giovanni',
    operatoreId: 'op3',
    operatoreNome: 'Bianchi Giulia',
    tipoIntervento: 'procedura',
    stato: 'programmato',
    priorita: 'urgente',
  ...
  },
  {
    ...
    pazienteNome: 'Ferrari, Anna',
    operatoreId: 'op4',
    operatoreNome: 'Esposito Luca',
    tipoIntervento: 'urgenza',
    stato: 'programmato',
    priorita: 'urgente',
...
export const MOCK_CAMERE: Camera[] = [
  {
    ...
    reparto: 'Cardiologia',
    stato: 'attiva',
    note: 'Camera con monitoraggio continuo.',
    letti: [
      {
        id: 'l101a',
        numero: 1,
  ...
  },
  {
    ...
    stato: 'attiva',
    note: '',
    letti: [{ id: 'l102a', numero: 1, stato: 'libero' }],
  },
  {
    id: 'cam201',
    numero: '201',
  ...
  },
  {
    ...
    reparto: 'Oncologia',
    stato: 'attiva',
    note: 'In attesa di manutenzione straordinaria.',
    letti: [{ id: 'l301a', numero: 1, stato: 'manutenzione' }],
  },
  {
    id: 'camPS01',
    numero: 'PS-01',
...
const GIORNI_LAVORATIVI: GiornoSettimana[] = [
  'lunedi',
  'martedi',
  'mercoledi',
  'giovedi',
...
export const MOCK_SCHEDULES: ScheduleOperatore[] = [
  {
    id: 'sch1',
    operatoreId: 'op1',
    note: 'Disponibile per urgenze anche il sabato mattina.',
    turni: GIORNI_LAVORATIVI.map((g) => ({
      giorno: g,
      oraInizio: '08:00',
      oraFine: '18:00',
      disponibile: true,
  ...
  },
  {
    ...
    note: 'Turno mattina.',
    turni: (
      ['lunedi', 'martedi', 'mercoledi', 'giovedi', 'venerdi', 'sabato'] as GiornoSettimana[]
    ).map((g) => ({ giorno: g, oraInizio: '07:00', oraFine: '15:00', disponibile: true })),
  },
  {
    id: 'sch4',
    operatoreId: 'op4',
    note: 'Turno pomeriggio/sera.',
    turni: (
      [
        'lunedi',
        'martedi',
...
export const MOCK_NOTE: Nota[] = [
  {
    id: 'n1',
    autoreId: 'op1',
    autoreNome: 'Dr. Marco Ferretti',
    destinatarioId: 'op3',
    destinatarioNome: 'Giulia Bianchi',
    pazienteNome: 'Rossi, Giovanni',
    priorita: 'urgente',
    stato: 'non_letta',
  ...
  },
  {
    id: 'n2',
    autoreId: 'op2',
    autoreNome: 'Dr.ssa Sofia Moretti',
    destinatarioId: 'admin',
    destinatarioNome: 'Amministrazione',
    priorita: 'alta',
    stato: 'letta',
  ...
  },
  {
    id: 'n3',
    autoreId: 'op4',
    autoreNome: 'Luca Esposito',
    destinatarioId: 'tutti',
    destinatarioNome: 'Tutti gli operatori',
    priorita: 'alta',
    stato: 'non_letta',
    messaggio:
      'Attenzione: aggiornare protocollo igienico reparto PS. Nuove disposizioni in vigore da oggi.',
    createdAt: today() + 'T09:00:00',
  },
  {
    id: 'n4',
    ...
    autoreNome: 'Dr. Marco Ferretti',
    destinatarioId: 'op2',
    destinatarioNome: 'Dr.ssa Sofia Moretti',
    pazienteNome: 'Neri, Carla',
    priorita: 'normale',
    stato: 'letta',
...
export const MOCK_STORIA_CLINICA: RecordClinico[] = [
  {
    ...
    tipo: 'Consulto',
    descrizione:
      'Visita annuale. Paziente riferisce affaticamento e lieve dispnea da sforzo. PA elevata 142/90.',
    operatore: 'Dr. A. Martínez',
    stato: 'risolto',
  },
  {
    data: '2024-08-03',
    tipo: 'Urgenza',
    descrizione:
      'Valutazione dolore toracico. ECG nella norma. Troponina I negativa ×2. Dimesso stabile.',
    operatore: 'Dr. R. Okonkwo',
    stato: 'risolto',
  },
  {
    data: '2024-03-15',
    tipo: 'Follow-up',
    descrizione:
      'Revisione ipertensione. PA in miglioramento con terapia combinata. Aderenza confermata.',
    operatore: 'Dr. A. Martínez',
    stato: 'attivo',
  },
  {
    ...
    tipo: 'Procedura',
    descrizione:
      'Ecocardiogramma: FE 58%. Lieve rigurgito mitralico. Nessuna anomalia strutturale significativa.',
    operatore: 'Dr. C. Nakamura',
    stato: 'monitoraggio',
  },
  {
    data: '2023-05-09',
    tipo: 'Diagnosi',
    descrizione:
      'Ipertensione essenziale (I10) diagnosticata. Avviata counselling su modifiche dello stile di vita.',
    operatore: 'Dr. A. Martínez',
    stato: 'attivo',
  },
];
...
export const MOCK_STORIA_TERAPIA: RecordTerapia[] = [
  {
    data: '2024-11-12',
    trattamento: 'Losartan',
    dosaggio: '50 mg 1×/die',
    note: 'Continuato. Risposta pressoria soddisfacente.',
    operatore: 'Dr. A. Martínez',
  },
  {
    data: '2024-08-03',
    trattamento: 'Aspirina',
    dosaggio: '300 mg stat',
    note: 'Somministrata al PS durante accertamento per dolore toracico.',
    operatore: 'Dr. R. Okonkwo',
  },
  {
    data: '2024-03-15',
    trattamento: 'Amlodipina',
    dosaggio: '5 mg 1×/die',
    note: 'Aggiunta per controllo pressorio insufficiente in monoterapia.',
    operatore: 'Dr. A. Martínez',
  },
  {
    data: '2023-10-22',
    trattamento: 'Ecocardiogramma',
    note: 'Esame cardiologico per valutazione strutturale.',
    operatore: 'Dr. C. Nakamura',
  },
  {
    data: '2023-05-09',
    trattamento: 'Intervento sullo stile di vita',
    note: 'Dieta DASH, sodio <2 g/die, attività aerobica 150 min/settimana.',
    operatore: 'Dr. A. Martínez',
  },
];
...
export const MOCK_ALLERGIE: Allergia[] = [
  ...
  {
    allergene: 'FANS (Ibuprofene)',
    reazione: 'Ulcera gastrica',
    gravita: 'moderata',
    documentato: '2021-07-22',
  },
  {
    allergene: 'Lattice',
    reazione: 'Dermatite da contatto',
    gravita: 'lieve',
    documentato: '2022-01-05',
  },
];
      ...
      administrations: [
        {
          ...
          scheduledTime: '08:00',
          status: 'administered',
          administeredAt: _data + 'T08:05:00',
          administeredBy: 'Giulia Bianchi',
      ...
      administrations: [
        {
          ...
          scheduledTime: '08:00',
          status: 'administered',
          administeredAt: _data + 'T08:10:00',
          administeredBy: 'Giulia Bianchi',
          notAdministeredReason: null,
        },
        {
