...
const EMPTY_DIM: DimissioneInfermieristica = {
  ...
  condizioni: 'stabili',
  autonomiaResidua: '',
  pianoCuraConsegnato: false,
  istruzioni: '',
  controlliProgrammati: '',
  personaAccompagna: '',
  mezzoTrasporto: '',
  ...
  respO2Terapia: false,
  respO2LitriMin: '',
  respCannulaTracheale: false,
  respUltimaSostituzione: '',
  // Alimentazione
  alimentAutonomo: false,
  alimentAssistito: false,
  alimentDieta: '',
  alimentSNG: '',
  alimentPEG: '',
  // Eliminazione
  elimContinente: false,
  elimParzialmenteIncontinente: false,
  elimIncontinenzaFeci: false,
  elimIncontinenzaUrine: false,
  elimDataUltimaEvacuazione: '',
  elimCatetereVescicale: '',
  elimStomia: false,
  // Mobilizzazione
  mobAutonomo: false,
  mobAllettato: false,
  mobAssistitoCon: '',
  mobRischioCaduta: false,
  mobContenzione: '',
  // Igiene
  igieneAutonomo: false,
  igieneDipendente: false,
  igieneParzialmenteDipendente: false,
  // Lesioni
  lesioniNo: true,
  lesioniSi: false,
  lesioniSede: '',
  lesioniGrado: '',
  lesioniTipoMedicazione: '',
  lesioniFrequenza: '',
  lesioniNote: '',
  // Sonno
  sonnoNo: true,
  ...
  // Comunicazione
  commOrientato: false,
  commParzialmenteOrientato: false,
  commDisorientato: false,
  commAlterazioniSensoriali: '',
  commComunicaSi: false,
  commComunicaNo: false,
  commDifficolta: '',
  // Servizi
  servizioSocialeSi: false,
  servizioSocialeNo: true,
  servizioDomiciliareSi: false,
  servizioDomiciliareNo: true,
};

const EMPTY_LIB: Liberatoria = {
  data: todayStr(),
  ora: nowTime(),
  controParereMedico: false,
  consapevoleRischi: false,
  firmaPatient: '',
  firmaTestimone: '',
  operatore: '',
  note: '',
...
function Fill({ width = 80 }: { width?: number }) {
  return (
    <span
      style={{ borderBottom: '1px dotted #999', minWidth: width, display: 'inline-block' }}
    ></span>
  );
}

// ── Modulo stampa dimissione ───────────────────────────────────────────────────
function DimissioneModulo({
  dim,
  lib,
  paziente,
}: {
  ...
  return (
    <div className="fm dimissione-modulo">
      ...
      <DimSection label="ALIMENTAZIONE">
        ...
        <span style={{ fontSize: '9pt' }}>
          dieta{' '}
          <span style={{ borderBottom: '1px dotted #999', minWidth: 80, display: 'inline-block' }}>
            {d?.alimentDieta}
          </span>
        </span>
      ...
      <DimSection label="ELIMINAZIONE">
        ...
        <span style={{ fontSize: '9pt' }}>
          ...
          <span style={{ borderBottom: '1px dotted #999', minWidth: 80, display: 'inline-block' }}>
            {d?.elimDataUltimaEvacuazione}
          </span>
        </span>
        <span style={{ fontSize: '9pt' }}>
          cat. vescicale{' '}
          <span style={{ borderBottom: '1px dotted #999', minWidth: 80, display: 'inline-block' }}>
            {d?.elimCatetereVescicale}
          </span>
        </span>
      ...
      <DimSection label="MOBILIZZAZIONE">
        ...
        <span style={{ fontSize: '9pt' }}>
          assistito con{' '}
          <span style={{ borderBottom: '1px dotted #999', minWidth: 100, display: 'inline-block' }}>
            {d?.mobAssistitoCon}
          </span>
        </span>
        <br style={{ width: '100%' }} />
        ...
        {d?.lesioniSi && (
          <>
            <span style={{ fontSize: '9pt' }}>
              SEDE{' '}
              <span
                style={{ borderBottom: '1px dotted #999', minWidth: 80, display: 'inline-block' }}
              >
                {d.lesioniSede}
              </span>
            </span>
            <span style={{ fontSize: '9pt' }}>
              grado{' '}
              <span
                style={{ borderBottom: '1px dotted #999', minWidth: 30, display: 'inline-block' }}
              >
                {d.lesioniGrado}
              </span>
            </span>
            ...
            <span style={{ fontSize: '9pt' }}>
              tipo medicazione{' '}
              <span
                style={{ borderBottom: '1px dotted #999', minWidth: 120, display: 'inline-block' }}
              >
                {d.lesioniTipoMedicazione}
              </span>
            </span>
            <span style={{ fontSize: '9pt' }}>
              frequenza{' '}
      ...
      <DimSection label="DISTURBI DEL SONNO">
        ...
        {d?.farmaciSi && d.farmaciDettaglio && (
          <span style={{ fontSize: '9pt' }}>{d.farmaciDettaglio}</span>
        )}
      </DimSection>
      ...
      <DimSection label="COMUNICAZIONE">
        ...
        <br style={{ width: '100%' }} />
        {d?.commAlterazioniSensoriali && (
          <span style={{ fontSize: '9pt' }}>
            alterazioni sensoriali: {d.commAlterazioniSensoriali}
          </span>
        )}
        ...
        {d?.commDifficolta && (
          <span style={{ fontSize: '9pt' }}>con difficoltà: {d.commDifficolta}</span>
        )}
      </DimSection>
      ...
      <DimSection label="SERV. TERRITORIALI">
        ...
        <span style={{ fontSize: '9pt', fontWeight: 600, marginLeft: 12 }}>
      ...
      <div className="fm-signature-row" style={{ marginTop: 16 }}>
        <div className="fm-signature">
          ...
          <div className="fm-signature__line">
      ...
      >
        ...
        <div className="fm-patient-header cols-4" style={{ marginBottom: 8 }}>
          ...
          <div className="fm-patient-field">
            ...
            <span className="fm-patient-field__val">
              {lib?.data ? lib.data.split('-').reverse().join('/') : ''}
            </span>
          </div>
          <div className="fm-patient-field">
        ...
        >
          <p>
            ...
            <span
              style={{ borderBottom: '1px dotted #999', display: 'inline-block', minWidth: 280 }}
            >
              {lib?.firmaPatient ?? ''}
            </span>
          </p>
          <p>
            quale ospite / referente dell'ospite della struttura, con la presente esonera la
            Direzione da ogni responsabilità per danni e conseguenze presenti o future che possano
            insorgere a causa di gesti, movimenti, azioni, posture, assunzione di cibi, bevande,
            farmaci e tutte le altre iniziative non conformi e/o non autorizzate, cioè tutto quanto
            possa causare danni fisici o compromettere la validità della terapia, per fatti
            procurati dall'ospite o da suoi parenti/visitatori, all'interno della struttura o
            all'esterno in occasione degli eventuali permessi di uscita.
          </p>
        </div>
...
function CbInput({
  ...
  return (
    <label
      style={{ display: 'flex', alignItems: 'center', gap: 6, cursor: 'pointer', fontSize: '14px' }}
    >
      <input
        type="checkbox"
        checked={checked}
        onChange={(e) => onChange(e.target.checked)}
        style={{ width: 15, height: 15, accentColor: '#2F6BED' }}
      />
      <span>{label}</span>
    </label>
  );
...
export function DimissioneTab({ cartella, paziente, onUpdate, operatoreNome }: Props) {
  ...
  const [dimForm, setDimForm] = useState<DimissioneInfermieristica>(
    dim ?? { ...EMPTY_DIM, operatore: operatoreNome },
  );
  const [editingLib, setEditingLib] = useState(false);
  const [libForm, setLibForm] = useState<Liberatoria>(
    lib ?? { ...EMPTY_LIB, operatore: operatoreNome },
  );
  const [showAddUscita, setShowAddUscita] = useState(false);
  const [uscitaForm, setUscitaForm] = useState<Partial<UscitaLog>>({});

  function setDim(f: Partial<DimissioneInfermieristica>) {
    setDimForm((p) => ({ ...p, ...f }));
  }
  function setLib(f: Partial<Liberatoria>) {
    setLibForm((p) => ({ ...p, ...f }));
  }
  function saveDim() {
    onUpdate({ dimissione: { ...dimForm, compilatoAt: nowISO() } });
    setEditingDim(false);
  }
  function saveLib() {
    onUpdate({ liberatoria: { ...libForm, compilatoAt: nowISO() } });
    setEditingLib(false);
  }
  ...
  function deleteUscita(id: string) {
    ...
    onUpdate({
      liberatoria: {
        ...cartella.liberatoria,
        usciteLog: (cartella.liberatoria.usciteLog ?? []).filter((u) => u.id !== id),
      },
    });
  }
            ...
            {editingDim ? (
              <div className="cr-inline-form">
                <div className="form-row-2col">
                  <div className="form-row">
                    ...
                    <input
                      ...
                      value={dimForm.data}
                      onChange={(e) => setDim({ data: e.target.value })}
                    />
                  </div>
                  <div className="form-row">
                    ...
                    <input
                      ...
                      className="form-input"
                      value={dimForm.ora}
                      onChange={(e) => setDim({ ora: e.target.value })}
                    />
                  </div>
                </div>
                ...
                <FormSection title="Respirazione">
                  <div
                    style={{ display: 'flex', flexWrap: 'wrap', gap: '8px 24px', marginBottom: 8 }}
                  >
                    <CbInput
                      checked={dimForm.respAutonomo ?? false}
                      label="Autonomo"
                      onChange={(v) => setDim({ respAutonomo: v })}
                    />
                    <CbInput
                      checked={dimForm.respO2Terapia ?? false}
                      label="O₂ terapia"
                      onChange={(v) => setDim({ respO2Terapia: v })}
                    />
                    <CbInput
                      checked={dimForm.respCannulaTracheale ?? false}
                      label="Cannula tracheale"
                      onChange={(v) => setDim({ respCannulaTracheale: v })}
                    />
                  </div>
                  <div className="form-row-2col">
                    {dimForm.respO2Terapia && (
                      <div className="form-row">
                        ...
                        <input
                          type="text"
                          className="form-input"
                          value={dimForm.respO2LitriMin ?? ''}
                          onChange={(e) => setDim({ respO2LitriMin: e.target.value })}
                          placeholder="es. 2"
                        />
                      </div>
                    )}
                    {dimForm.respCannulaTracheale && (
                      <div className="form-row">
                        ...
                        <input
                          type="date"
                          className="form-input"
                          value={dimForm.respUltimaSostituzione ?? ''}
                          onChange={(e) => setDim({ respUltimaSostituzione: e.target.value })}
                        />
                      </div>
                    )}
                  </div>
                ...
                <FormSection title="Alimentazione">
                  ...
                  >
                    <CbInput
                      checked={dimForm.alimentAutonomo ?? false}
                      label="Autonomo"
                      onChange={(v) => setDim({ alimentAutonomo: v })}
                    />
                    <CbInput
                      checked={dimForm.alimentAssistito ?? false}
                      label="Assistito"
                      onChange={(v) => setDim({ alimentAssistito: v })}
                    />
                    <CbInput
                      checked={!!dimForm.alimentSNG}
                      label="SNG"
                      onChange={(v) => setDim({ alimentSNG: v ? dimForm.alimentSNG || '' : '' })}
                    />
                    <CbInput
                      checked={!!dimForm.alimentPEG}
                      label="PEG"
                      onChange={(v) => setDim({ alimentPEG: v ? dimForm.alimentPEG || '' : '' })}
                    />
                  </div>
                  <div className="form-row-3col">
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={dimForm.alimentDieta ?? ''}
                        onChange={(e) => setDim({ alimentDieta: e.target.value })}
                        placeholder="es. libera, tritatina…"
                      />
                    </div>
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={dimForm.alimentSNG ?? ''}
                        onChange={(e) => setDim({ alimentSNG: e.target.value })}
                        disabled={!dimForm.alimentSNG && dimForm.alimentSNG !== ''}
                        placeholder="es. 14Ch"
                      />
                    </div>
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={dimForm.alimentPEG ?? ''}
                        onChange={(e) => setDim({ alimentPEG: e.target.value })}
                        placeholder="es. 20Fr"
                      />
                    </div>
                  </div>
                ...
                <FormSection title="Eliminazione">
                  ...
                  >
                    <CbInput
                      checked={dimForm.elimContinente ?? false}
                      label="Continente"
                      onChange={(v) => setDim({ elimContinente: v })}
                    />
                    <CbInput
                      checked={dimForm.elimParzialmenteIncontinente ?? false}
                      label="Parzialmente incontinente"
                      onChange={(v) => setDim({ elimParzialmenteIncontinente: v })}
                    />
                    <CbInput
                      checked={dimForm.elimIncontinenzaFeci ?? false}
                      label="Incontinenza feci"
                      onChange={(v) => setDim({ elimIncontinenzaFeci: v })}
                    />
                    <CbInput
                      checked={dimForm.elimIncontinenzaUrine ?? false}
                      label="Incontinenza urine"
                      onChange={(v) => setDim({ elimIncontinenzaUrine: v })}
                    />
                    <CbInput
                      checked={dimForm.elimStomia ?? false}
                      label="Stomia"
                      onChange={(v) => setDim({ elimStomia: v })}
                    />
                  </div>
                  <div className="form-row-2col">
                    <div className="form-row">
                      ...
                      <input
                        type="date"
                        className="form-input"
                        value={dimForm.elimDataUltimaEvacuazione ?? ''}
                        onChange={(e) => setDim({ elimDataUltimaEvacuazione: e.target.value })}
                      />
                    </div>
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={dimForm.elimCatetereVescicale ?? ''}
                        onChange={(e) => setDim({ elimCatetereVescicale: e.target.value })}
                        placeholder="es. 16Ch Foley"
                      />
                    </div>
                  </div>
                </FormSection>
                ...
                <FormSection title="Mobilizzazione">
                  ...
                  >
                    <CbInput
                      checked={dimForm.mobAutonomo ?? false}
                      label="Autonomo"
                      onChange={(v) => setDim({ mobAutonomo: v })}
                    />
                    <CbInput
                      checked={dimForm.mobAllettato ?? false}
                      label="Allettato"
                      onChange={(v) => setDim({ mobAllettato: v })}
                    />
                    <CbInput
                      checked={dimForm.mobRischioCaduta ?? false}
                      label="Rischio caduta"
                      onChange={(v) => setDim({ mobRischioCaduta: v })}
                    />
                  </div>
                  <div className="form-row-2col">
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={dimForm.mobAssistitoCon ?? ''}
                        onChange={(e) => setDim({ mobAssistitoCon: e.target.value })}
                        placeholder="es. deambulatore, carrozzina…"
                      />
                    </div>
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={dimForm.mobContenzione ?? ''}
                        onChange={(e) => setDim({ mobContenzione: e.target.value })}
                        placeholder="tipo di contenzione applicata"
                      />
                    </div>
                  </div>
                </FormSection>
                ...
                <FormSection title="Igiene e vestizione">
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px 24px' }}>
                    <CbInput
                      checked={dimForm.igieneAutonomo ?? false}
                      label="Autonomo"
                      onChange={(v) => setDim({ igieneAutonomo: v })}
                    />
                    <CbInput
                      checked={dimForm.igieneDipendente ?? false}
                      label="Dipendente"
                      onChange={(v) => setDim({ igieneDipendente: v })}
                    />
                    <CbInput
                      checked={dimForm.igieneParzialmenteDipendente ?? false}
                      label="Parzialmente dipendente"
                      onChange={(v) => setDim({ igieneParzialmenteDipendente: v })}
                    />
                  </div>
                </FormSection>
                ...
                <FormSection title="Lesioni da pressione">
                  ...
                  >
                    <CbInput
                      checked={dimForm.lesioniNo ?? true}
                      label="Assenti"
                      onChange={(v) => setDim({ lesioniNo: v, lesioniSi: !v })}
                    />
                    <CbInput
                      checked={dimForm.lesioniSi ?? false}
                      label="Presenti"
                      onChange={(v) => setDim({ lesioniSi: v, lesioniNo: !v })}
                    />
                  </div>
                  {dimForm.lesioniSi && (
                    <div className="form-row-3col">
                      <div className="form-row">
                        ...
                        <input
                          type="text"
                          className="form-input"
                          value={dimForm.lesioniSede ?? ''}
                          onChange={(e) => setDim({ lesioniSede: e.target.value })}
                        />
                      </div>
                      <div className="form-row">
                        ...
                        <select
                          className="form-input"
                          value={dimForm.lesioniGrado ?? ''}
                          onChange={(e) => setDim({ lesioniGrado: e.target.value })}
                        >
                          <option value="">—</option>
                          <option>1°</option>
                          <option>2°</option>
                      ...
                      <div className="form-row">
                        ...
                        <input
                          type="text"
                          className="form-input"
                          value={dimForm.lesioniTipoMedicazione ?? ''}
                          onChange={(e) => setDim({ lesioniTipoMedicazione: e.target.value })}
                        />
                      </div>
                      <div className="form-row">
                        ...
                        <input
                          type="text"
                          className="form-input"
                          value={dimForm.lesioniFrequenza ?? ''}
                          onChange={(e) => setDim({ lesioniFrequenza: e.target.value })}
                        />
                      </div>
                      <div className="form-row" style={{ gridColumn: '2/4' }}>
                        ...
                        <input
                          type="text"
                          className="form-input"
                          value={dimForm.lesioniNote ?? ''}
                          onChange={(e) => setDim({ lesioniNote: e.target.value })}
                        />
                      </div>
                    </div>
                  )}
                ...
                <FormSection title="Disturbi del sonno">
                  ...
                  >
                    <CbInput
                      checked={dimForm.sonnoNo ?? true}
                      label="Assenti"
                      onChange={(v) => setDim({ sonnoNo: v, sonnoSi: !v })}
                    />
                    <CbInput
                      checked={dimForm.sonnoSi ?? false}
                      label="Presenti"
                      onChange={(v) => setDim({ sonnoSi: v, sonnoNo: !v })}
                    />
                  </div>
                  {dimForm.sonnoSi && (
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={dimForm.sonnoNote ?? ''}
                        onChange={(e) => setDim({ sonnoNote: e.target.value })}
                      />
                    </div>
                  )}
                </FormSection>
                ...
                <FormSection title="Uso di farmaci">
                  ...
                  >
                    <CbInput
                      checked={dimForm.farmaciNo ?? true}
                      label="No"
                      onChange={(v) => setDim({ farmaciNo: v, farmaciSi: !v })}
                    />
                    <CbInput
                      checked={dimForm.farmaciSi ?? false}
                      label="Sì"
                      onChange={(v) => setDim({ farmaciSi: v, farmaciNo: !v })}
                    />
                  </div>
                  {dimForm.farmaciSi && (
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={dimForm.farmaciDettaglio ?? ''}
                        onChange={(e) => setDim({ farmaciDettaglio: e.target.value })}
                      />
                    </div>
                  )}
                </FormSection>
                ...
                <FormSection title="Comunicazione / Orientamento">
                  ...
                  >
                    <CbInput
                      checked={dimForm.commOrientato ?? false}
                      label="Orientato"
                      onChange={(v) => setDim({ commOrientato: v })}
                    />
                    <CbInput
                      checked={dimForm.commParzialmenteOrientato ?? false}
                      label="Parzialmente orientato"
                      onChange={(v) => setDim({ commParzialmenteOrientato: v })}
                    />
                    <CbInput
                      checked={dimForm.commDisorientato ?? false}
                      label="Disorientato"
                      onChange={(v) => setDim({ commDisorientato: v })}
                    />
                  </div>
                  <div className="form-row-2col">
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={dimForm.commAlterazioniSensoriali ?? ''}
                        onChange={(e) => setDim({ commAlterazioniSensoriali: e.target.value })}
                      />
                    </div>
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={dimForm.commDifficolta ?? ''}
                        onChange={(e) => setDim({ commDifficolta: e.target.value })}
                      />
                    </div>
                  </div>
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px 24px', marginTop: 8 }}>
                    <CbInput
                      checked={dimForm.commComunicaSi ?? false}
                      label="Comunica — Sì"
                      onChange={(v) => setDim({ commComunicaSi: v, commComunicaNo: !v })}
                    />
                    <CbInput
                      checked={dimForm.commComunicaNo ?? false}
                      label="Comunica — No"
                      onChange={(v) => setDim({ commComunicaNo: v, commComunicaSi: !v })}
                    />
                  </div>
                </FormSection>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                    <div>
                      ...
                      <div style={{ display: 'flex', gap: 16 }}>
                        <CbInput
                          checked={dimForm.servizioSocialeSi ?? false}
                          label="Sì"
                          onChange={(v) => setDim({ servizioSocialeSi: v, servizioSocialeNo: !v })}
                        />
                        <CbInput
                          checked={dimForm.servizioSocialeNo ?? true}
                          label="No"
                          onChange={(v) => setDim({ servizioSocialeNo: v, servizioSocialeSi: !v })}
                        />
                      </div>
                    </div>
                    <div>
                      ...
                      <div style={{ display: 'flex', gap: 16 }}>
                        <CbInput
                          checked={dimForm.servizioDomiciliareSi ?? false}
                          label="Sì"
                          onChange={(v) =>
                            setDim({ servizioDomiciliareSi: v, servizioDomiciliareNo: !v })
                          }
                        />
                        <CbInput
                          checked={dimForm.servizioDomiciliareNo ?? true}
                          label="No"
                          onChange={(v) =>
                            setDim({ servizioDomiciliareNo: v, servizioDomiciliareSi: !v })
                          }
                        />
                      </div>
                    </div>
                ...
                <div className="form-row">
                  ...
                  <textarea
                    className="form-input"
                    rows={2}
                    value={dimForm.istruzioni}
                    onChange={(e) => setDim({ istruzioni: e.target.value })}
                  />
                </div>
                <div className="form-row">
                  ...
                  <textarea
                    className="form-input"
                    rows={2}
                    value={dimForm.controlliProgrammati}
                    onChange={(e) => setDim({ controlliProgrammati: e.target.value })}
                  />
                </div>
                <div className="form-row">
                  ...
                  <textarea
                    className="form-input"
                    rows={2}
                    value={dimForm.materialeConsegnato}
                    onChange={(e) => setDim({ materialeConsegnato: e.target.value })}
                  />
                </div>
                <div className="form-row-2col">
                  <div className="form-row">
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={dimForm.pianoCuraConsegnato}
                        onChange={(e) => setDim({ pianoCuraConsegnato: e.target.checked })}
                      />
                      <span className="form-label" style={{ margin: 0 }}>
                        Piano di cura consegnato
                      </span>
                    </label>
                  </div>
                  <div className="form-row">
                    ...
                    <input
                      type="text"
                      className="form-input"
                      value={dimForm.operatore}
                      onChange={(e) => setDim({ operatore: e.target.value })}
                    />
                  </div>
                </div>
                <div className="form-row">
            ...
            <div style={{ marginTop: 32, borderTop: '1px solid var(--border)', paddingTop: 24 }}>
              ...
              {editingLib ? (
                <div className="cr-inline-form">
                  ...
                  >
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={libForm.soloUscitaParenti ?? false}
                        onChange={(e) => setLib({ soloUscitaParenti: e.target.checked })}
                      />
                  ...
                  <div className="form-row-3col">
                    <div className="form-row">
                      ...
                      <input
                        ...
                        className="form-input"
                        value={libForm.data}
                        onChange={(e) => setLib({ data: e.target.value })}
                      />
                    </div>
                    <div className="form-row">
                      ...
                      <input
                        ...
                        className="form-input"
                        value={libForm.ora}
                        onChange={(e) => setLib({ ora: e.target.value })}
                      />
                    </div>
                  </div>
                  <div className="form-row-3col">
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={libForm.referenteNome ?? ''}
                        onChange={(e) => setLib({ referenteNome: e.target.value })}
                      />
                    </div>
                    <div className="form-row">
                      ...
                      <input
                        type="date"
                        className="form-input"
                        value={libForm.referenteDataNascita ?? ''}
                        onChange={(e) => setLib({ referenteDataNascita: e.target.value })}
                      />
                    </div>
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={libForm.referenteRapporto ?? ''}
                        onChange={(e) => setLib({ referenteRapporto: e.target.value })}
                  ...
                  >
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={libForm.controParereMedico}
                        onChange={(e) => setLib({ controParereMedico: e.target.checked })}
                        style={{ marginTop: 2 }}
                      />
                      <span className="form-label" style={{ margin: 0 }}>
                        Uscita <strong>contro parere medico</strong>
                      </span>
                    </label>
                  </div>
                  <div className="form-row">
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={libForm.consapevoleRischi}
                        onChange={(e) => setLib({ consapevoleRischi: e.target.checked })}
                        style={{ marginTop: 2 }}
                      />
                      <span className="form-label" style={{ margin: 0 }}>
                        Informato/a dei rischi
                      </span>
                    </label>
                  </div>
                  <div className="form-row-2col">
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={libForm.firmaPatient}
                        onChange={(e) => setLib({ firmaPatient: e.target.value })}
                      />
                    </div>
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={libForm.firmaTestimone}
                        onChange={(e) => setLib({ firmaTestimone: e.target.value })}
                      />
                    </div>
                  </div>
                  <div className="form-row-2col">
                    <div className="form-row">
                      ...
                      <input
                        type="text"
                        className="form-input"
                        value={libForm.operatore}
                        onChange={(e) => setLib({ operatore: e.target.value })}
                      />
                    </div>
                  </div>
                  <div className="form-row">
                    ...
                    <textarea
                      ...
                      rows={2}
                      value={libForm.note}
                      onChange={(e) => setLib({ note: e.target.value })}
                    />
                  </div>
                  <div className="cr-inline-form__actions">
                ...
                <div className="cr-form-section">
                  <div className="pic-row">
                    <span className="pic-row__lbl">Data / Ora uscita</span>
                    <span className="pic-row__val">
                      {lib.data.split('-').reverse().join('/')} {lib.ora}
                    </span>
                  </div>
                  {lib.referenteNome && (
                    <div className="pic-row">
                      <span className="pic-row__lbl">Referente</span>
                      <span className="pic-row__val">
                        {lib.referenteNome} ({lib.referenteRapporto})
                      </span>
                    </div>
                  )}
                  {lib.referenteDataNascita && (
                    <div className="pic-row">
                      <span className="pic-row__lbl">Data nascita referente</span>
                      <span className="pic-row__val">
                        {lib.referenteDataNascita.split('-').reverse().join('/')}
                      </span>
                    </div>
                  )}
                  <div className="pic-row">
                    <span className="pic-row__lbl">Contro parere medico</span>
                    <span className="pic-row__val">{lib.controParereMedico ? 'Sì' : 'No'}</span>
                  </div>
                  <div className="pic-row">
                    <span className="pic-row__lbl">Consapevole dei rischi</span>
                    <span className="pic-row__val">{lib.consapevoleRischi ? 'Sì' : 'No'}</span>
                  </div>
                  <div className="pic-row">
                    <span className="pic-row__lbl">Firma paziente/tutore</span>
                    <span className="pic-row__val">{lib.firmaPatient}</span>
                  </div>
                  <div className="pic-row">
                    <span className="pic-row__lbl">Firma testimone</span>
                    <span className="pic-row__val">{lib.firmaTestimone}</span>
                  </div>
                  <div className="pic-row">
                    <span className="pic-row__lbl">Operatore</span>
                    <span className="pic-row__val">{lib.operatore}</span>
                  </div>
                  {lib.note && (
                    <div className="pic-row">
                      <span className="pic-row__lbl">Note</span>
                      <span className="pic-row__val">{lib.note}</span>
                    </div>
                  )}
                </div>
              ) : (
              ...
              <div style={{ marginTop: 20 }}>
                <div className="cr-section-header" style={{ marginBottom: 10 }}>
                  <span className="cr-section-title" style={{ fontSize: 13 }}>
                    ...
                    <div className="form-row-3col">
                      <div className="form-row">
                        ...
                        <input
                          type="date"
                          className="form-input"
                          value={uscitaForm.data ?? ''}
                          onChange={(e) => setUscitaForm((p) => ({ ...p, data: e.target.value }))}
                        />
                      </div>
                      <div className="form-row">
                        <label className="form-label">Ora uscita *</label>
                        <input
                          ...
                          onChange={(e) => setUscitaForm((p) => ({ ...p, ora: e.target.value }))}
                        />
                      </div>
                      <div className="form-row">
                        ...
                        <input
                          type="time"
                          className="form-input"
                          value={uscitaForm.oraRientro ?? ''}
                          onChange={(e) =>
                            setUscitaForm((p) => ({ ...p, oraRientro: e.target.value }))
                          }
                        />
                      </div>
                    </div>
                    <div className="form-row-2col">
                      <div className="form-row">
                        ...
                        <input
                          type="text"
                          className="form-input"
                          value={uscitaForm.referenteNome ?? ''}
                          onChange={(e) =>
                            setUscitaForm((p) => ({ ...p, referenteNome: e.target.value }))
                          }
                        />
                      </div>
                      <div className="form-row">
                        ...
                        <input
                          type="text"
                          className="form-input"
                          value={uscitaForm.firma ?? ''}
                          onChange={(e) => setUscitaForm((p) => ({ ...p, firma: e.target.value }))}
                        />
                      </div>
                    </div>
                    <div className="form-row">
                      ...
                      <input
                        ...
                        onChange={(e) => setUscitaForm((p) => ({ ...p, note: e.target.value }))}
                      />
                    </div>
                    <div className="cr-inline-form__actions">
                      <button
                  ...
                  columns={[
                    {
                      ...
                      label: 'Data',
                      width: '110px',
                      render: (_v, u) => u.data.split('-').reverse().join('/'),
                    },
                    { key: 'ora', label: 'Ora uscita', width: '100px', render: (_v, u) => u.ora },
                    {
                      ...
                      label: 'Rientro',
                      width: '100px',
                      render: (_v, u) => u.oraRientro ?? '—',
                    },
                    {
                      key: 'referenteNome',
                      label: 'Accompagnato da',
                      render: (_v, u) => u.referenteNome ?? '—',
                    },
...
function DimissioneDisplay({ dim }: { dim: DimissioneInfermieristica }) {
  ...
  if (dim.respO2Terapia)
    respItems.push(`O₂ terapia${dim.respO2LitriMin ? ' ' + dim.respO2LitriMin + ' lt/min' : ''}`);
  if (dim.respCannulaTracheale)
    respItems.push(
      `Cannula tracheale${dim.respUltimaSostituzione ? ' (sost. ' + dim.respUltimaSostituzione.split('-').reverse().join('/') + ')' : ''}`,
    );
  ...
  if (dim.elimDataUltimaEvacuazione)
    elimItems.push(
      'Ultima evacuazione: ' + dim.elimDataUltimaEvacuazione.split('-').reverse().join('/'),
    );
    ...
    <div style={{ border: '1px solid var(--border)', borderRadius: 8, overflow: 'hidden' }}>
      ...
      <div style={{ padding: '10px 14px', display: 'flex', gap: 16, flexWrap: 'wrap' }}>
        <span style={{ fontSize: '12px', color: 'var(--text-muted)' }}>
          Data: {dim.data.split('-').reverse().join('/')}
        </span>
        {dim.operatore && (
          <span style={{ fontSize: '12px', color: 'var(--text-muted)' }}>
            Operatore: {dim.operatore}
          </span>
        )}
      </div>
    </div>
