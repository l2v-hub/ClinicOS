...
export function ImportedDocumentsList({ patientId }: { patientId: string }) {
        ...
        {docs.map((d) => (
          <li key={d.id} className="imported-docs__item">
            ...
            <span className="imported-docs__actions">
              ...
              <a className="srev-chip" href={`${API_URL}/patients/${patientId}/documents/${d.id}/content`} target="_blank" rel="noreferrer">Apri</a>
            </span>
          </li>
        ))}
      </ul>
