...
export function ArchivePdfPreview({ file, name }: { file: Blob; name: string }) {
  ...
  return (
    <div className="patient-archive-pdf">
      <div className="patient-archive-pdf__toolbar" aria-label="Controlli PDF">
        <button
          type="button"
      ...
      <div ref={stage} className="patient-archive-pdf__stage" aria-busy={status === 'loading'}>
        ...
        />
        {text && <p className="patient-archive-pdf__accessible">{text}</p>}
      </div>
    </div>
  );
}
