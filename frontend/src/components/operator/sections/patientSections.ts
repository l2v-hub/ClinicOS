...
export const PATIENT_SECTIONS: PatientSectionDefinition[] = [
  { sectionKey: 'allergie',   title: 'Allergie',            component: AllergiesEditor as unknown as ComponentType<SectionProps<never>>, availableDuringIntake: true,  requiredDuringIntake: false, supportedByDocumentImport: true,  permissions: ['operatore'] },
  { sectionKey: 'anamnesi',   title: 'Anamnesi',            component: AnamnesisEditor as unknown as ComponentType<SectionProps<never>>, availableDuringIntake: true,  requiredDuringIntake: false, supportedByDocumentImport: true,  permissions: ['operatore'] },
  { sectionKey: 'diagnosi',   title: 'Diagnosi',            component: DiagnosisEditor as unknown as ComponentType<SectionProps<never>>, availableDuringIntake: true,  requiredDuringIntake: false, supportedByDocumentImport: true,  permissions: ['operatore'] },
