...
import type { Paziente, Consegna } from '../../types';
import { IcoSearch, IcoX, IcoChevronRight, IcoAlert } from '../../icons';
...
export function PatientList({ pazienti, consegne, loading, onSelect }: PatientListProps) {
