...
try {
  ...
  for (const file of files) {
    ...
    const child = spawn(process.execPath, ['--import', 'tsx', '--test', '--test-concurrency=1', file], {
      ...
      env: { ...process.env, DATABASE_URL: database.url, AUTH_MODE: 'demo', NODE_ENV: 'test', AI_VOICE_ENABLED: 'true', AI_WRITE_ACTIONS_ENABLED: 'true', GDS15_PDF_QA_DIRECTORY: '', MNA_PDF_QA_DIRECTORY: '', TINETTI_PDF_QA_DIRECTORY: '', ASSESSMENT_PDF_QA_DIRECTORY: '', TRANSFERS_PDF_QA_DIRECTORY: '' },
    });
