...
const inputTreeSha256=tree(inputs), tests=await json('catalog-focused-tests.json'), checks=await json('validation-checks.json');
...
const manifest={task:'PO-15-backend',root,branch:session.branch,baseline:session.baseline,capturedAt:checks.completedAt,
