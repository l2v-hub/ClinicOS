...
let prisma: typeof import('file:///C:/Workspace/ClinicOSHouse-worktrees/po05-import-runtime/backend/src/lib/prisma.js').prisma;
let server: Server;
let base: string;
...
before(async () => {
  ...
  ({ prisma } = await import('file:///C:/Workspace/ClinicOSHouse-worktrees/po05-import-runtime/backend/src/lib/prisma.js'));
  const { default: router } = await import('file:///C:/Workspace/ClinicOSHouse-worktrees/po05-import-runtime/artifacts/task-validation/po-05-scansioni-lunghe/backend/baseline-route.mts');
