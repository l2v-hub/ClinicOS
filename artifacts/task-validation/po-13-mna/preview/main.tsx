...
function Preview(){
 ...
 return <>
 <header className="no-print" style={{background:'#dce8f5',padding:12}}><strong>PO13 · solo pazienti sintetici</strong>
