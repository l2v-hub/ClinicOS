...
const inputTreeSha256=tree(inputs), tests=await json('mna-focused-tests.json'), checks=await json('validation-checks.json');
...
const manifest={task:'PO-13-backend',root,branch:session.branch,baseline:session.baseline,capturedAt:checks.completedAt,
