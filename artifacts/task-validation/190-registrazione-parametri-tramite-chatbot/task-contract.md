# Task Contract — #190 Registrazione parametri tramite chatbot
...
## Objective
Produce objective Playwright evidence that #190 meets its acceptance criteria on the current code
