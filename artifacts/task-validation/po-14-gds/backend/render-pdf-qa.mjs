...
const qa=resolve('artifacts/task-validation/po-14-gds/backend/pdf-qa');
...
const specs=[
 ['gds15-normal.pdf','gds15-normal'],['gds15-long.pdf','gds15-long'],
 ['mna-regression/mna-full-normal.pdf','mna-full-normal'],['mna-regression/mna-full-long.pdf','mna-full-long'],['mna-regression/mna-screening-partial.pdf','mna-screening-partial'],
