...
const artifactRoot = resolve(root, 'artifacts/task-validation/po-08-consegne-giro/backend');
...
const files = selected.length ? selected : [
  'backend/src/consegne/__tests__/creation-db.test.ts',
  'backend/src/consegne/__tests__/patient-summary-db.test.ts',
  'backend/src/consegne/__tests__/voice-creation-db.test.ts',
  'backend/src/patients/__tests__/room-filter-db.test.ts',
  'backend/src/consegne/__tests__/query.test.ts',
