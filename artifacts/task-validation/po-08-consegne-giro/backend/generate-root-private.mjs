...
const artifact = resolve(root, 'artifacts/task-validation/po-08-consegne-giro/backend');
...
const result = spawnSync(process.execPath, [resolve(root, 'node_modules/prisma/build/index.js'), 'generate', '--schema', schemaPath], {
  ...
  env: { ...process.env, DATABASE_URL: 'postgresql://postgres@127.0.0.1:1/po08_generate_only', PRISMA_GENERATE_SKIP_AUTOINSTALL: '1' },
});
