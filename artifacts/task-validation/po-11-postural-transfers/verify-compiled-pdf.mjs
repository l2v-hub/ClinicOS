...
const folder=resolve('artifacts/task-validation/po-11-postural-transfers');
...
if(!finals.some(a=>a.type==='postural_transfers'))throw new Error('No synthetic final Transfers snapshot');
