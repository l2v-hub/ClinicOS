...
<>
  ...
  <ClinicalCard title="Condizioni iniziali" onEdit={() => setEditingId('cond')}>
    ...
  </ClinicalCard>
  <ClinicalCard title="Valutazione funzionale" onEdit={() => setEditingId('valutazione')}>
    ...
  </ClinicalCard>
  <ClinicalCard title="Documenti e firma" onEdit={() => setEditingId('docs')}>
    ...
  </ClinicalCard>
</>
```
