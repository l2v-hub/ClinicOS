# BUG-042 — Acceptance matrix

Issue: #64 — *Righe diagnosi con codice ICD vuoto*

## Triage result: ALREADY RESOLVED IN CODE (verify-on-deploy)

No structured diagnosis rows (and no ICD field) are created by the import. Regression test asserts no icd/icdCode key on the row.
