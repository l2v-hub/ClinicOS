---
id: 'component.repository.source.1fbfb020cddb450ede2f'
kind: 'repository-source'
title: 'migration.sql'
status: 'observed'
summary: 'Repository source path prisma/migrations/20260629040947_unique_intake_draft_import_job/migration.sql classified as semantic-source.'
bounded_contexts: []
sources:
...
What does `component.repository.source.1fbfb020cddb450ede2f` represent in ClinicOS?

## Canonical Definition

component.repository.source.1fbfb020cddb450ede2f is the canonical repository-source named migration.sql.
