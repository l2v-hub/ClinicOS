---
id: 'component.repository.source.35eb2c5ba70c149885ea'
kind: 'repository-source'
title: 'task-4-brief.md'
status: 'declared'
summary: 'Repository source path .superpowers/sdd/task-4-brief.md classified as narrative-source.'
bounded_contexts: []
sources:
  - path: '.superpowers/sdd/task-4-brief.md'
    confidence: 'declared'
relations:
  - type: 'belongs-to'
    target: 'system.clinicos'
    evidence: '.superpowers/sdd/task-4-brief.md'
    confidence: 'observed'
tags:
  - 'repository-source'
  - 'narrative-source'
...
What does `component.repository.source.35eb2c5ba70c149885ea` represent in ClinicOS?

## Canonical Definition

component.repository.source.35eb2c5ba70c149885ea is the canonical repository-source named task-4-brief.md.
