---
id: 'component.repository.source.e907a9acb1b3c91ce031'
kind: 'repository-source'
title: 'PatientCompactHeader.tsx'
status: 'observed'
summary: 'Repository source path frontend/src/components/operator/PatientCompactHeader.tsx classified as semantic-source.'
bounded_contexts: []
sources:
...
What does `component.repository.source.e907a9acb1b3c91ce031` represent in ClinicOS?

## Canonical Definition

component.repository.source.e907a9acb1b3c91ce031 is the canonical repository-source named PatientCompactHeader.tsx.
