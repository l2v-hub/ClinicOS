---
id: 'component.repository.source.9f58f14b0befa91175c3'
kind: 'repository-source'
title: 'SKILL.md'
status: 'declared'
summary: 'Repository source path .claude/skills/speckit-taskstoissues/SKILL.md classified as narrative-source.'
bounded_contexts: []
sources:
...
relations:
  - type: 'belongs-to'
    ...
    evidence: '.claude/skills/speckit-taskstoissues/SKILL.md'
    confidence: 'observed'
tags:
  - 'repository-source'
  - 'narrative-source'
...
What does `component.repository.source.9f58f14b0befa91175c3` represent in ClinicOS?

## Canonical Definition

component.repository.source.9f58f14b0befa91175c3 is the canonical repository-source named SKILL.md.
