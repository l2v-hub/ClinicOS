---
id: 'component.repository.source.8b60be22f06ef19ea3a7'
kind: 'repository-source'
title: 'eslint.config.js'
status: 'observed'
summary: 'Repository source path frontend/eslint.config.js classified as semantic-source.'
bounded_contexts: []
sources:
...
What does `component.repository.source.8b60be22f06ef19ea3a7` represent in ClinicOS?

## Canonical Definition

component.repository.source.8b60be22f06ef19ea3a7 is the canonical repository-source named eslint.config.js.
