---
id: 'component.repository.source.4cbb847035a553a2b99b'
kind: 'repository-source'
title: 'SKILL.md'
status: 'declared'
summary: 'Repository source path .claude/skills/speckit-analyze/SKILL.md classified as narrative-source.'
bounded_contexts: []
sources:
  - path: '.claude/skills/speckit-analyze/SKILL.md'
    confidence: 'declared'
relations:
  - type: 'belongs-to'
    target: 'system.clinicos'
    evidence: '.claude/skills/speckit-analyze/SKILL.md'
    confidence: 'observed'
tags:
  - 'repository-source'
  - 'narrative-source'
...
What does `component.repository.source.4cbb847035a553a2b99b` represent in ClinicOS?

## Canonical Definition

component.repository.source.4cbb847035a553a2b99b is the canonical repository-source named SKILL.md.
