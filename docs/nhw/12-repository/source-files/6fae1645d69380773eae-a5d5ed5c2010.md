---
id: 'component.repository.source.6fae1645d69380773eae'
kind: 'repository-source'
title: 'useSpeechOutput.ts'
status: 'observed'
summary: 'Repository source path frontend/src/components/shared/agnos/useSpeechOutput.ts classified as semantic-source.'
bounded_contexts: []
sources:
...
What does `component.repository.source.6fae1645d69380773eae` represent in ClinicOS?

## Canonical Definition

component.repository.source.6fae1645d69380773eae is the canonical repository-source named useSpeechOutput.ts.
...
- `frontend/src/components/shared/agnos/useSpeechOutput.ts`
