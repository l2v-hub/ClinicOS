---
id: 'component.repository.source.fefa8a2beec5b9094f24'
kind: 'repository-source'
title: 'SKILL.md'
status: 'declared'
summary: 'Repository source path .claude/skills/speckit-git-validate/SKILL.md classified as narrative-source.'
bounded_contexts: []
sources:
  - path: '.claude/skills/speckit-git-validate/SKILL.md'
    confidence: 'declared'
relations:
  - type: 'belongs-to'
    target: 'system.clinicos'
    evidence: '.claude/skills/speckit-git-validate/SKILL.md'
    confidence: 'observed'
tags:
  - 'repository-source'
  - 'narrative-source'
...
What does `component.repository.source.fefa8a2beec5b9094f24` represent in ClinicOS?

## Canonical Definition

component.repository.source.fefa8a2beec5b9094f24 is the canonical repository-source named SKILL.md.
