---
id: 'component.repository.source.423bc8b469b0a3e430bd'
kind: 'repository-source'
title: 'task-4-report.md'
status: 'declared'
summary: 'Repository source path .superpowers/sdd/task-4-report.md classified as narrative-source.'
bounded_contexts: []
sources:
...
relations:
  - type: 'belongs-to'
    ...
    evidence: '.superpowers/sdd/task-4-report.md'
    confidence: 'observed'
tags:
  - 'repository-source'
  - 'narrative-source'
...
What does `component.repository.source.423bc8b469b0a3e430bd` represent in ClinicOS?

## Canonical Definition

component.repository.source.423bc8b469b0a3e430bd is the canonical repository-source named task-4-report.md.
