---
id: 'component.repository.source.0f2df96a34c072134f54'
kind: 'repository-source'
title: 'task-9-report.md'
status: 'declared'
summary: 'Repository source path .superpowers/sdd/task-9-report.md classified as narrative-source.'
bounded_contexts: []
sources:
  - path: '.superpowers/sdd/task-9-report.md'
    confidence: 'declared'
relations:
  - type: 'belongs-to'
    target: 'system.clinicos'
    evidence: '.superpowers/sdd/task-9-report.md'
    confidence: 'observed'
tags:
  - 'repository-source'
  - 'narrative-source'
...
What does `component.repository.source.0f2df96a34c072134f54` represent in ClinicOS?

## Canonical Definition

component.repository.source.0f2df96a34c072134f54 is the canonical repository-source named task-9-report.md.
