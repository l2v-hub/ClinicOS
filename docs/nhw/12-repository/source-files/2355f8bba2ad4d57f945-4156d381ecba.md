---
id: 'component.repository.source.2355f8bba2ad4d57f945'
kind: 'repository-source'
title: 'task-5-report.md'
status: 'declared'
summary: 'Repository source path .superpowers/sdd/task-5-report.md classified as narrative-source.'
bounded_contexts: []
sources:
  - path: '.superpowers/sdd/task-5-report.md'
    confidence: 'declared'
relations:
  - type: 'belongs-to'
    target: 'system.clinicos'
    evidence: '.superpowers/sdd/task-5-report.md'
    confidence: 'observed'
tags:
  - 'repository-source'
  - 'narrative-source'
...
What does `component.repository.source.2355f8bba2ad4d57f945` represent in ClinicOS?

## Canonical Definition

component.repository.source.2355f8bba2ad4d57f945 is the canonical repository-source named task-5-report.md.
