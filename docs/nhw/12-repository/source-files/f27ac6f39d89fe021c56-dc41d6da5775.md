---
id: 'component.repository.source.f27ac6f39d89fe021c56'
kind: 'repository-source'
title: 'settings.json'
status: 'observed'
summary: 'Repository source path .claude/settings.json classified as configuration-source.'
bounded_contexts: []
sources:
...
What does `component.repository.source.f27ac6f39d89fe021c56` represent in ClinicOS?

## Canonical Definition

component.repository.source.f27ac6f39d89fe021c56 is the canonical repository-source named settings.json.
