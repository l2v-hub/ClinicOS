---
id: 'component.repository.source.9ffbd33f934f25ac62dd'
kind: 'repository-source'
title: 'PatientSection.tsx'
status: 'observed'
summary: 'Repository source path frontend/src/components/operator/sections/PatientSection.tsx classified as semantic-source.'
bounded_contexts: []
sources:
...
What does `component.repository.source.9ffbd33f934f25ac62dd` represent in ClinicOS?

## Canonical Definition

component.repository.source.9ffbd33f934f25ac62dd is the canonical repository-source named PatientSection.tsx.
