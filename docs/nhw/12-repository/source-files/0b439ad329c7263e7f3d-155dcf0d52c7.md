---
id: 'component.repository.source.0b439ad329c7263e7f3d'
kind: 'repository-source'
title: 'run-qa.sh'
status: 'observed'
summary: 'Repository source path .claude/team/run-qa.sh classified as deployment-source.'
bounded_contexts: []
sources:
  - path: '.claude/team/run-qa.sh'
    confidence: 'observed'
relations:
  - type: 'belongs-to'
    target: 'system.clinicos'
    evidence: '.claude/team/run-qa.sh'
    confidence: 'observed'
tags:
  - 'repository-source'
  - 'deployment-source'
...
What does `component.repository.source.0b439ad329c7263e7f3d` represent in ClinicOS?

## Canonical Definition

component.repository.source.0b439ad329c7263e7f3d is the canonical repository-source named run-qa.sh.
