...
What does `api.backend.post-internal-ai-search-documents-58` represent in ClinicOS?

## Canonical Definition

api.backend.post-internal-ai-search-documents-58 is the canonical api-endpoint named POST /internal/ai/search/documents.

## Inputs

- Method: `POST`
- Path: `/internal/ai/search/documents`
...
- `backend/src/routes/internal-ai.ts:57-60` — internalAiRouter
