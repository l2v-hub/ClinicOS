---
id: "api.backend.get-admin-rooms-by-param-6"
kind: "api-endpoint"
title: "GET /admin/rooms/:roomId"
status: "observed"
summary: "GET /admin/rooms/:roomId endpoint implemented by the express runtime."
bounded_contexts:
...
What does `api.backend.get-admin-rooms-by-param-6` represent in ClinicOS?

## Canonical Definition

api.backend.get-admin-rooms-by-param-6 is the canonical api-endpoint named GET /admin/rooms/:roomId.
...
Persistence calls: `["prisma.room.findUnique"]`
