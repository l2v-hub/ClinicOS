...
What does `test.repository.backend.src.ai.tests.patient-documents-security.test.ts` represent in ClinicOS?

## Canonical Definition

test.repository.backend.src.ai.tests.patient-documents-security.test.ts is the canonical security-test named patient-documents-security.test.ts.

## Inputs

Test source: `backend/src/ai/__tests__/patient-documents-security.test.ts`.
