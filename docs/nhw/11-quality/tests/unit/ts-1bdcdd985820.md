---
id: 'test.repository.backend.src.ai.tests.lazy-sections.test.ts'
kind: 'unit-test'
title: 'lazy-sections.test.ts'
status: 'observed'
...
relations:
  - type: 'belongs-to'
    ...
    evidence: 'backend/src/ai/__tests__/lazy-sections.test.ts'
    confidence: 'observed'
tags:
  - 'test'
  - 'unit'
...
What does `test.repository.backend.src.ai.tests.lazy-sections.test.ts` represent in ClinicOS?

## Canonical Definition

test.repository.backend.src.ai.tests.lazy-sections.test.ts is the canonical unit-test named lazy-sections.test.ts.

## Inputs

Test source: `backend/src/ai/__tests__/lazy-sections.test.ts`.
...
- `backend/src/ai/__tests__/lazy-sections.test.ts`
