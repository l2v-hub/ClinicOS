---
id: "test.repository.backend.src.tests.codice-fiscale.test.ts"
kind: "unit-test"
title: "codice-fiscale.test.ts"
status: "observed"
summary: "node-test unit test surface."
bounded_contexts: []
sources:
  - path: "backend/src/__tests__/codice-fiscale.test.ts"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.backend"
    evidence: "backend/src/__tests__/codice-fiscale.test.ts"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.backend.src.tests.codice-fiscale.test.ts` represent in ClinicOS?

## Canonical Definition

test.repository.backend.src.tests.codice-fiscale.test.ts is the canonical unit-test named codice-fiscale.test.ts.

## Inputs

Test source: `backend/src/__tests__/codice-fiscale.test.ts`.
