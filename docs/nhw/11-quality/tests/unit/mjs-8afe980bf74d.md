---
id: "test.repository.agent-team.tests.unit.worker-policy.test.mjs"
kind: "unit-test"
title: "worker-policy.test.mjs"
status: "observed"
summary: "node-test unit test surface."
bounded_contexts: []
sources:
  - path: "agent-team/tests/unit/worker-policy.test.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.agent-team"
    evidence: "agent-team/tests/unit/worker-policy.test.mjs"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.agent-team.tests.unit.worker-policy.test.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.agent-team.tests.unit.worker-policy.test.mjs is the canonical unit-test named worker-policy.test.mjs.

## Inputs

Test source: `agent-team/tests/unit/worker-policy.test.mjs`.
