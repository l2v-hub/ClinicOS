---
id: "test.repository.scripts.nhw.test.determinism.test.mjs"
kind: "unit-test"
title: "determinism.test.mjs"
status: "observed"
summary: "node-test unit test surface."
bounded_contexts: []
sources:
  - path: "scripts/nhw/test/determinism.test.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.repository-automation"
    evidence: "scripts/nhw/test/determinism.test.mjs"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.scripts.nhw.test.determinism.test.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.scripts.nhw.test.determinism.test.mjs is the canonical unit-test named determinism.test.mjs.

## Inputs

Test source: `scripts/nhw/test/determinism.test.mjs`.
