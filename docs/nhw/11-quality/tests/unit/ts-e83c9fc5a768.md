---
id: "test.repository.frontend.src.lib.tests.legacyanamnesis.test.ts"
kind: "unit-test"
title: "legacyAnamnesis.test.ts"
status: "observed"
summary: "node-test unit test surface."
bounded_contexts: []
sources:
  - path: "frontend/src/lib/__tests__/legacyAnamnesis.test.ts"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.frontend"
    evidence: "frontend/src/lib/__tests__/legacyAnamnesis.test.ts"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.frontend.src.lib.tests.legacyanamnesis.test.ts` represent in ClinicOS?

## Canonical Definition

test.repository.frontend.src.lib.tests.legacyanamnesis.test.ts is the canonical unit-test named legacyAnamnesis.test.ts.

## Inputs

Test source: `frontend/src/lib/__tests__/legacyAnamnesis.test.ts`.
