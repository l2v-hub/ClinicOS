---
id: "test.repository.backend.src.ai.tests.merge.test.ts"
kind: "unit-test"
title: "merge.test.ts"
status: "observed"
...
bounded_contexts: []
sources:
  - path: "backend/src/ai/__tests__/merge.test.ts"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.backend"
    evidence: "backend/src/ai/__tests__/merge.test.ts"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.backend.src.ai.tests.merge.test.ts` represent in ClinicOS?

## Canonical Definition

test.repository.backend.src.ai.tests.merge.test.ts is the canonical unit-test named merge.test.ts.

## Inputs

Test source: `backend/src/ai/__tests__/merge.test.ts`.
