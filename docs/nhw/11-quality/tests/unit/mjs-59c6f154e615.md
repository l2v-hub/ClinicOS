---
id: "test.repository.scripts.nhw.test.typescript-extractor.test.mjs"
kind: "unit-test"
title: "typescript-extractor.test.mjs"
status: "observed"
summary: "node-test unit test surface."
bounded_contexts: []
sources:
  - path: "scripts/nhw/test/typescript-extractor.test.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.repository-automation"
    evidence: "scripts/nhw/test/typescript-extractor.test.mjs"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.scripts.nhw.test.typescript-extractor.test.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.scripts.nhw.test.typescript-extractor.test.mjs is the canonical unit-test named typescript-extractor.test.mjs.

## Inputs

Test source: `scripts/nhw/test/typescript-extractor.test.mjs`.
