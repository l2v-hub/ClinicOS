---
id: "test.repository.backend.src.ai.tests.vitals-trend.test.ts"
kind: "unit-test"
title: "vitals-trend.test.ts"
status: "observed"
summary: "node-test unit test surface."
bounded_contexts: []
sources:
  - path: "backend/src/ai/__tests__/vitals-trend.test.ts"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.backend"
    evidence: "backend/src/ai/__tests__/vitals-trend.test.ts"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.backend.src.ai.tests.vitals-trend.test.ts` represent in ClinicOS?

## Canonical Definition

test.repository.backend.src.ai.tests.vitals-trend.test.ts is the canonical unit-test named vitals-trend.test.ts.

## Inputs

Test source: `backend/src/ai/__tests__/vitals-trend.test.ts`.
