---
id: "test.repository.agent-team.tests.unit.state-machine.test.mjs"
kind: "unit-test"
title: "state-machine.test.mjs"
status: "observed"
summary: "node-test unit test surface."
bounded_contexts: []
sources:
  - path: "agent-team/tests/unit/state-machine.test.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.agent-team"
    evidence: "agent-team/tests/unit/state-machine.test.mjs"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.agent-team.tests.unit.state-machine.test.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.agent-team.tests.unit.state-machine.test.mjs is the canonical unit-test named state-machine.test.mjs.

## Inputs

Test source: `agent-team/tests/unit/state-machine.test.mjs`.
