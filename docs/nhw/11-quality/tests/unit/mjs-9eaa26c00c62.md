---
id: "test.repository.agent-team.tests.unit.process-runner.test.mjs"
kind: "unit-test"
title: "process-runner.test.mjs"
status: "observed"
summary: "node-test unit test surface."
bounded_contexts: []
sources:
  - path: "agent-team/tests/unit/process-runner.test.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.agent-team"
    evidence: "agent-team/tests/unit/process-runner.test.mjs"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.agent-team.tests.unit.process-runner.test.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.agent-team.tests.unit.process-runner.test.mjs is the canonical unit-test named process-runner.test.mjs.

## Inputs

Test source: `agent-team/tests/unit/process-runner.test.mjs`.
