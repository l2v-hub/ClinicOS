---
id: "test.repository.clinicos-ai-runtime.tests.test-azure-gpt5.py"
kind: "unit-test"
title: "test_azure_gpt5.py"
status: "observed"
summary: "unittest unit test surface."
bounded_contexts: []
sources:
  - path: "clinicos-ai-runtime/tests/test_azure_gpt5.py"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos-ai-runtime"
    evidence: "clinicos-ai-runtime/tests/test_azure_gpt5.py"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.clinicos-ai-runtime.tests.test-azure-gpt5.py` represent in ClinicOS?

## Canonical Definition

test.repository.clinicos-ai-runtime.tests.test-azure-gpt5.py is the canonical unit-test named test_azure_gpt5.py.

## Inputs

Test source: `clinicos-ai-runtime/tests/test_azure_gpt5.py`.
