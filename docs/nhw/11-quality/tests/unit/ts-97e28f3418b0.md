---
id: 'test.repository.backend.src.ai.tests.config.test.ts'
kind: 'unit-test'
...
relations:
  - type: 'belongs-to'
    ...
    evidence: 'backend/src/ai/__tests__/config.test.ts'
    confidence: 'observed'
tags:
  - 'test'
  - 'unit'
...
What does `test.repository.backend.src.ai.tests.config.test.ts` represent in ClinicOS?

## Canonical Definition

test.repository.backend.src.ai.tests.config.test.ts is the canonical unit-test named config.test.ts.

## Inputs

Test source: `backend/src/ai/__tests__/config.test.ts`.
