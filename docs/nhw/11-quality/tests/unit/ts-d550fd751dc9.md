---
id: 'test.repository.backend.src.tests.patient-documents-entra.test.ts'
kind: 'unit-test'
title: 'patient-documents-entra.test.ts'
status: 'observed'
...
relations:
  - type: 'belongs-to'
    ...
    evidence: 'backend/src/__tests__/patient-documents-entra.test.ts'
    confidence: 'observed'
tags:
  - 'test'
  - 'unit'
...
What does `test.repository.backend.src.tests.patient-documents-entra.test.ts` represent in ClinicOS?

## Canonical Definition

test.repository.backend.src.tests.patient-documents-entra.test.ts is the canonical unit-test named patient-documents-entra.test.ts.

## Inputs

Test source: `backend/src/__tests__/patient-documents-entra.test.ts`.
