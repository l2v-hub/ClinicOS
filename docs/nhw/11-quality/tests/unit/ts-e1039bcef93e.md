---
id: "test.repository.backend.src.tests.entra-auth.test.ts"
kind: "unit-test"
title: "entra-auth.test.ts"
status: "observed"
summary: "node-test unit test surface."
bounded_contexts: []
sources:
  - path: "backend/src/__tests__/entra-auth.test.ts"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.backend"
    evidence: "backend/src/__tests__/entra-auth.test.ts"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.backend.src.tests.entra-auth.test.ts` represent in ClinicOS?

## Canonical Definition

test.repository.backend.src.tests.entra-auth.test.ts is the canonical unit-test named entra-auth.test.ts.

## Inputs

Test source: `backend/src/__tests__/entra-auth.test.ts`.
