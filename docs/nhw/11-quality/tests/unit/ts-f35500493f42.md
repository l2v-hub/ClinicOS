---
id: "test.repository.frontend.src.lib.tests.allergystatusmodel.test.ts"
kind: "unit-test"
title: "allergyStatusModel.test.ts"
status: "observed"
summary: "node-test unit test surface."
bounded_contexts: []
sources:
  - path: "frontend/src/lib/__tests__/allergyStatusModel.test.ts"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.frontend"
    evidence: "frontend/src/lib/__tests__/allergyStatusModel.test.ts"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.frontend.src.lib.tests.allergystatusmodel.test.ts` represent in ClinicOS?

## Canonical Definition

test.repository.frontend.src.lib.tests.allergystatusmodel.test.ts is the canonical unit-test named allergyStatusModel.test.ts.

## Inputs

Test source: `frontend/src/lib/__tests__/allergyStatusModel.test.ts`.
