---
id: 'test.repository.backend.src.ai.tests.composer.test.ts'
kind: 'unit-test'
...
bounded_contexts: []
sources:
  - path: 'backend/src/ai/__tests__/composer.test.ts'
    confidence: 'observed'
relations:
  - type: 'belongs-to'
    target: 'project.backend'
    evidence: 'backend/src/ai/__tests__/composer.test.ts'
    confidence: 'observed'
tags:
  - 'test'
  - 'unit'
...
What does `test.repository.backend.src.ai.tests.composer.test.ts` represent in ClinicOS?

## Canonical Definition

test.repository.backend.src.ai.tests.composer.test.ts is the canonical unit-test named composer.test.ts.

## Inputs

Test source: `backend/src/ai/__tests__/composer.test.ts`.
