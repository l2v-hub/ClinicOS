---
id: "test.repository.scripts.nhw.test.knowledge-compiler.test.mjs"
kind: "unit-test"
title: "knowledge-compiler.test.mjs"
status: "observed"
summary: "node-test unit test surface."
bounded_contexts: []
sources:
  - path: "scripts/nhw/test/knowledge-compiler.test.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.repository-automation"
    evidence: "scripts/nhw/test/knowledge-compiler.test.mjs"
    confidence: "observed"
tags:
  - "test"
  - "unit"
...
What does `test.repository.scripts.nhw.test.knowledge-compiler.test.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.scripts.nhw.test.knowledge-compiler.test.mjs is the canonical unit-test named knowledge-compiler.test.mjs.

## Inputs

Test source: `scripts/nhw/test/knowledge-compiler.test.mjs`.
