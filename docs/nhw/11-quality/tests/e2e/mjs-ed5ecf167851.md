---
id: "test.repository.e2e.prod-dump.mjs"
kind: "e2e-test"
title: "prod-dump.mjs"
status: "observed"
...
bounded_contexts: []
sources:
  - path: "e2e/prod-dump.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos"
    evidence: "e2e/prod-dump.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.prod-dump.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.prod-dump.mjs is the canonical e2e-test named prod-dump.mjs.

## Inputs

Test source: `e2e/prod-dump.mjs`.
