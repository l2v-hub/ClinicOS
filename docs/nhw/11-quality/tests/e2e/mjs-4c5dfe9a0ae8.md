---
id: 'test.repository.e2e.therapy-import-api.mjs'
kind: 'e2e-test'
title: 'therapy-import-api.mjs'
status: 'observed'
summary: 'node-test e2e test surface.'
bounded_contexts: []
sources:
  - path: 'e2e/therapy-import-api.mjs'
    confidence: 'observed'
relations:
  - type: 'belongs-to'
    target: 'project.clinicos'
    evidence: 'e2e/therapy-import-api.mjs'
    confidence: 'observed'
tags:
  - 'test'
  - 'e2e'
...
What does `test.repository.e2e.therapy-import-api.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.therapy-import-api.mjs is the canonical e2e-test named therapy-import-api.mjs.

## Inputs

Test source: `e2e/therapy-import-api.mjs`.
