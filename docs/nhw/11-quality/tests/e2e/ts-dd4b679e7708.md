---
id: "test.repository.e2e.issue-242-parse.ts"
kind: "e2e-test"
title: "issue-242-parse.ts"
status: "observed"
summary: "node-test e2e test surface."
bounded_contexts: []
sources:
  - path: "e2e/issue-242-parse.ts"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos"
    evidence: "e2e/issue-242-parse.ts"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.issue-242-parse.ts` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.issue-242-parse.ts is the canonical e2e-test named issue-242-parse.ts.

## Inputs

Test source: `e2e/issue-242-parse.ts`.
