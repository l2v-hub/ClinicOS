---
id: "test.repository.e2e.import-happy-path.mjs"
kind: "e2e-test"
title: "import-happy-path.mjs"
status: "observed"
...
relations:
  - type: "belongs-to"
    ...
    evidence: "e2e/import-happy-path.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.import-happy-path.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.import-happy-path.mjs is the canonical e2e-test named import-happy-path.mjs.

## Inputs

Test source: `e2e/import-happy-path.mjs`.
