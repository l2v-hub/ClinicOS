---
id: "test.repository.e2e.verify-91-dolore.mjs"
kind: "e2e-test"
title: "verify-91-dolore.mjs"
status: "observed"
...
relations:
  - type: "belongs-to"
    ...
    evidence: "e2e/verify-91-dolore.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.verify-91-dolore.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.verify-91-dolore.mjs is the canonical e2e-test named verify-91-dolore.mjs.

## Inputs

Test source: `e2e/verify-91-dolore.mjs`.
