---
id: "test.repository.e2e.verify-94-multiorari.mjs"
kind: "e2e-test"
title: "verify-94-multiorari.mjs"
status: "observed"
...
relations:
  - type: "belongs-to"
    ...
    evidence: "e2e/verify-94-multiorari.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.verify-94-multiorari.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.verify-94-multiorari.mjs is the canonical e2e-test named verify-94-multiorari.mjs.

## Inputs

Test source: `e2e/verify-94-multiorari.mjs`.
