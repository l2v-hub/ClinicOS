---
id: "test.repository.e2e.issue-127-verify.mjs"
kind: "e2e-test"
title: "issue-127-verify.mjs"
status: "observed"
...
relations:
  - type: "belongs-to"
    ...
    evidence: "e2e/issue-127-verify.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.issue-127-verify.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.issue-127-verify.mjs is the canonical e2e-test named issue-127-verify.mjs.

## Inputs

Test source: `e2e/issue-127-verify.mjs`.
