---
id: "test.repository.e2e.invio-ps-shot.mjs"
kind: "e2e-test"
title: "invio-ps-shot.mjs"
status: "observed"
summary: "node-test e2e test surface."
bounded_contexts: []
sources:
  - path: "e2e/invio-ps-shot.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos"
    evidence: "e2e/invio-ps-shot.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.invio-ps-shot.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.invio-ps-shot.mjs is the canonical e2e-test named invio-ps-shot.mjs.

## Inputs

Test source: `e2e/invio-ps-shot.mjs`.
