---
id: "test.repository.e2e.prod-real-check.mjs"
kind: "e2e-test"
title: "prod-real-check.mjs"
status: "observed"
...
relations:
  - type: "belongs-to"
    ...
    evidence: "e2e/prod-real-check.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.prod-real-check.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.prod-real-check.mjs is the canonical e2e-test named prod-real-check.mjs.

## Inputs

Test source: `e2e/prod-real-check.mjs`.
