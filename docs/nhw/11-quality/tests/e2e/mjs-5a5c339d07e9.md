---
id: 'test.repository.e2e.issue-241-giorni-settimana.mjs'
kind: 'e2e-test'
title: 'issue-241-giorni-settimana.mjs'
status: 'observed'
summary: 'node-test e2e test surface.'
bounded_contexts: []
sources:
  - path: 'e2e/issue-241-giorni-settimana.mjs'
    confidence: 'observed'
relations:
  - type: 'belongs-to'
    target: 'project.clinicos'
    evidence: 'e2e/issue-241-giorni-settimana.mjs'
    confidence: 'observed'
tags:
  - 'test'
  - 'e2e'
...
What does `test.repository.e2e.issue-241-giorni-settimana.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.issue-241-giorni-settimana.mjs is the canonical e2e-test named issue-241-giorni-settimana.mjs.

## Inputs

Test source: `e2e/issue-241-giorni-settimana.mjs`.
...
- `e2e/issue-241-giorni-settimana.mjs`
