---
id: "test.repository.e2e.therapy-import.spec.ts"
kind: "e2e-test"
title: "therapy-import.spec.ts"
status: "observed"
...
relations:
  - type: "belongs-to"
    ...
    evidence: "e2e/therapy-import.spec.ts"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.therapy-import.spec.ts` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.therapy-import.spec.ts is the canonical e2e-test named therapy-import.spec.ts.

## Inputs

Test source: `e2e/therapy-import.spec.ts`.
