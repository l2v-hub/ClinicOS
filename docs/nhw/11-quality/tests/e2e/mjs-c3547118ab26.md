---
id: "test.repository.e2e.issue-243-moduli.mjs"
kind: "e2e-test"
title: "issue-243-moduli.mjs"
status: "observed"
summary: "node-test e2e test surface."
bounded_contexts: []
sources:
  - path: "e2e/issue-243-moduli.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos"
    evidence: "e2e/issue-243-moduli.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.issue-243-moduli.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.issue-243-moduli.mjs is the canonical e2e-test named issue-243-moduli.mjs.

## Inputs

Test source: `e2e/issue-243-moduli.mjs`.
