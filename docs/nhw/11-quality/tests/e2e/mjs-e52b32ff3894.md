---
id: "test.repository.e2e.real-pdf.mjs"
kind: "e2e-test"
title: "real-pdf.mjs"
status: "observed"
...
What does `test.repository.e2e.real-pdf.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.real-pdf.mjs is the canonical e2e-test named real-pdf.mjs.

## Inputs

Test source: `e2e/real-pdf.mjs`.
