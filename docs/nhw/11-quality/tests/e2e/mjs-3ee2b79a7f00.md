---
id: "test.repository.e2e.req027-sections-shots.mjs"
kind: "e2e-test"
title: "req027-sections-shots.mjs"
status: "observed"
summary: "node-test e2e test surface."
bounded_contexts: []
sources:
  - path: "e2e/req027-sections-shots.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos"
    evidence: "e2e/req027-sections-shots.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.req027-sections-shots.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.req027-sections-shots.mjs is the canonical e2e-test named req027-sections-shots.mjs.

## Inputs

Test source: `e2e/req027-sections-shots.mjs`.
