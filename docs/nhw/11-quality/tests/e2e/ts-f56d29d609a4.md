---
id: "test.repository.e2e.remediation.pw.config.256.ts"
kind: "e2e-test"
title: "pw.config.256.ts"
status: "observed"
summary: "node-test e2e test surface."
bounded_contexts: []
sources:
  - path: "e2e/remediation/pw.config.256.ts"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos"
    evidence: "e2e/remediation/pw.config.256.ts"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.remediation.pw.config.256.ts` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.remediation.pw.config.256.ts is the canonical e2e-test named pw.config.256.ts.

## Inputs

Test source: `e2e/remediation/pw.config.256.ts`.
...
- `e2e/remediation/pw.config.256.ts`
