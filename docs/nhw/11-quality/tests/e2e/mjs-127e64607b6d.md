---
id: 'test.repository.e2e.import-e2e.mjs'
kind: 'e2e-test'
title: 'import-e2e.mjs'
status: 'observed'
summary: 'node-test e2e test surface.'
bounded_contexts: []
sources:
  - path: 'e2e/import-e2e.mjs'
    confidence: 'observed'
relations:
  - type: 'belongs-to'
    target: 'project.clinicos'
    evidence: 'e2e/import-e2e.mjs'
    confidence: 'observed'
tags:
  - 'test'
  - 'e2e'
...
What does `test.repository.e2e.import-e2e.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.import-e2e.mjs is the canonical e2e-test named import-e2e.mjs.

## Inputs

Test source: `e2e/import-e2e.mjs`.
