---
id: "test.repository.e2e.verify-96-contenzioni.mjs"
kind: "e2e-test"
title: "verify-96-contenzioni.mjs"
status: "observed"
...
relations:
  - type: "belongs-to"
    ...
    evidence: "e2e/verify-96-contenzioni.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.verify-96-contenzioni.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.verify-96-contenzioni.mjs is the canonical e2e-test named verify-96-contenzioni.mjs.

## Inputs

Test source: `e2e/verify-96-contenzioni.mjs`.
