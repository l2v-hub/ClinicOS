---
id: "test.repository.e2e.prod-camera-verify.mjs"
kind: "e2e-test"
title: "prod-camera-verify.mjs"
status: "observed"
...
relations:
  - type: "belongs-to"
    ...
    evidence: "e2e/prod-camera-verify.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.prod-camera-verify.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.prod-camera-verify.mjs is the canonical e2e-test named prod-camera-verify.mjs.

## Inputs

Test source: `e2e/prod-camera-verify.mjs`.
