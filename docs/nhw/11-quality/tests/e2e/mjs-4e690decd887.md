---
id: "test.repository.e2e.camera-preview-check.mjs"
kind: "e2e-test"
title: "camera-preview-check.mjs"
status: "observed"
summary: "node-test e2e test surface."
bounded_contexts: []
sources:
  - path: "e2e/camera-preview-check.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos"
    evidence: "e2e/camera-preview-check.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.camera-preview-check.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.camera-preview-check.mjs is the canonical e2e-test named camera-preview-check.mjs.

## Inputs

Test source: `e2e/camera-preview-check.mjs`.
