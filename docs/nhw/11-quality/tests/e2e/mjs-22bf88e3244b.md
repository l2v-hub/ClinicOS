---
id: "test.repository.e2e.shot-cartella-card.mjs"
kind: "e2e-test"
title: "shot-cartella-card.mjs"
status: "observed"
...
relations:
  - type: "belongs-to"
    ...
    evidence: "e2e/shot-cartella-card.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.shot-cartella-card.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.shot-cartella-card.mjs is the canonical e2e-test named shot-cartella-card.mjs.

## Inputs

Test source: `e2e/shot-cartella-card.mjs`.
