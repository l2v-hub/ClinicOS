---
id: "test.repository.e2e.intake-scroll.mjs"
kind: "e2e-test"
title: "intake-scroll.mjs"
status: "observed"
summary: "node-test e2e test surface."
bounded_contexts: []
sources:
  - path: "e2e/intake-scroll.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos"
    evidence: "e2e/intake-scroll.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.intake-scroll.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.intake-scroll.mjs is the canonical e2e-test named intake-scroll.mjs.

## Inputs

Test source: `e2e/intake-scroll.mjs`.
