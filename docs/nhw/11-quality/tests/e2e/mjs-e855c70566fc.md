---
id: "test.repository.e2e.req093-therapy-shots.mjs"
kind: "e2e-test"
title: "req093-therapy-shots.mjs"
status: "observed"
summary: "node-test e2e test surface."
bounded_contexts: []
sources:
  - path: "e2e/req093-therapy-shots.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos"
    evidence: "e2e/req093-therapy-shots.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.req093-therapy-shots.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.req093-therapy-shots.mjs is the canonical e2e-test named req093-therapy-shots.mjs.

## Inputs

Test source: `e2e/req093-therapy-shots.mjs`.
