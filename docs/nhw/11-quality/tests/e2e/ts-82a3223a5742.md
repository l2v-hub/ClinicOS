---
id: 'test.repository.e2e.remediation.issue-245.spec.ts'
kind: 'e2e-test'
title: 'issue-245.spec.ts'
status: 'observed'
...
relations:
  - type: 'belongs-to'
    ...
    evidence: 'e2e/remediation/issue-245.spec.ts'
    confidence: 'observed'
tags:
  - 'test'
  - 'e2e'
...
What does `test.repository.e2e.remediation.issue-245.spec.ts` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.remediation.issue-245.spec.ts is the canonical e2e-test named issue-245.spec.ts.

## Inputs

Test source: `e2e/remediation/issue-245.spec.ts`.
...
- `e2e/remediation/issue-245.spec.ts`
