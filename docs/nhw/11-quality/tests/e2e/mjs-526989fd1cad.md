---
id: "test.repository.e2e.prod-probe.mjs"
kind: "e2e-test"
title: "prod-probe.mjs"
status: "observed"
...
What does `test.repository.e2e.prod-probe.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.prod-probe.mjs is the canonical e2e-test named prod-probe.mjs.

## Inputs

Test source: `e2e/prod-probe.mjs`.
