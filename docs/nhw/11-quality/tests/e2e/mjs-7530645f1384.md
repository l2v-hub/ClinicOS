---
id: "test.repository.e2e.async-smoke.mjs"
kind: "e2e-test"
title: "async-smoke.mjs"
status: "observed"
summary: "node-test e2e test surface."
bounded_contexts: []
sources:
  - path: "e2e/async-smoke.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos"
    evidence: "e2e/async-smoke.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.async-smoke.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.async-smoke.mjs is the canonical e2e-test named async-smoke.mjs.

## Inputs

Test source: `e2e/async-smoke.mjs`.
