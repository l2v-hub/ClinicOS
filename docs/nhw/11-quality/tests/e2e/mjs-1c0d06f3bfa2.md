---
id: 'test.repository.e2e.issue-130-repro.mjs'
kind: 'e2e-test'
title: 'issue-130-repro.mjs'
status: 'observed'
...
relations:
  - type: 'belongs-to'
    ...
    evidence: 'e2e/issue-130-repro.mjs'
    confidence: 'observed'
tags:
  - 'test'
  - 'e2e'
...
What does `test.repository.e2e.issue-130-repro.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.issue-130-repro.mjs is the canonical e2e-test named issue-130-repro.mjs.

## Inputs

Test source: `e2e/issue-130-repro.mjs`.
