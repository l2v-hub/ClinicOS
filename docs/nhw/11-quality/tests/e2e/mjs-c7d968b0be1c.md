---
id: "test.repository.e2e.synthetic-letter.mjs"
kind: "e2e-test"
title: "synthetic-letter.mjs"
status: "observed"
summary: "node-test e2e test surface."
bounded_contexts: []
sources:
  - path: "e2e/synthetic-letter.mjs"
    confidence: "observed"
relations:
  - type: "belongs-to"
    target: "project.clinicos"
    evidence: "e2e/synthetic-letter.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.synthetic-letter.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.synthetic-letter.mjs is the canonical e2e-test named synthetic-letter.mjs.

## Inputs

Test source: `e2e/synthetic-letter.mjs`.
