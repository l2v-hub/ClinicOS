---
id: "test.repository.e2e.prod-conflict-check.mjs"
kind: "e2e-test"
title: "prod-conflict-check.mjs"
status: "observed"
...
relations:
  - type: "belongs-to"
    ...
    evidence: "e2e/prod-conflict-check.mjs"
    confidence: "observed"
tags:
  - "test"
  - "e2e"
...
What does `test.repository.e2e.prod-conflict-check.mjs` represent in ClinicOS?

## Canonical Definition

test.repository.e2e.prod-conflict-check.mjs is the canonical e2e-test named prod-conflict-check.mjs.

## Inputs

Test source: `e2e/prod-conflict-check.mjs`.
