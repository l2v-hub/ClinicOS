...
## Chiusura tecnica PO-16

Le note precedenti conservano il ragionamento preparatorio. L'implementazione e gli esiti attuali sono nel registro del piano e nelle specifiche aggiornate. Il giro sintetico integrato è superato; backend15test mirati, frontend174test, build, browser e PDF compilato verificati. PO16 cambia soltanto presentazione MNA e dimensioni dei comandi mobili: `1 punto`, decimali italiani e IMC leggibile senza alterare risposte/punteggi/snapshot, nuoviPDFv2 e PDFv1 esistenti identici. Nessuna nuova migrazione o modifica del runtimeIA.

La guida di verifica del delivery distingue ciò che è stato collaudato tecnicamente dalle prove da osservare con personale, fotocamere e stampanti fisiche. Nessuna scrittura di test sui pazienti online e nessuna convalida clinica indipendente attribuita al collaudo.
