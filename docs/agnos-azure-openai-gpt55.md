...
| `AZURE_OPENAI_API_KEY` | *(segreto, solo su Railway)* | mai committata, mai in log, mai al frontend |
| `OPENAI_API_VERSION` | *(secondo l'API surface Azure)* | usata dall'SDK Azure/Agno |
