...
async function main() {
  ...
  try {
    ...
    // ── 1. Users ──────────────────────────────────────────────────────────────
    const usersData = [
      { id: 'SEED-USER-001', email: 'admin.demo@clinicos.demo',
        fullName: 'Admin Demo',      role: 'MANAGER'   as const },
      { id: 'SEED-USER-002', email: 'laura.bianchi@clinicos.demo',
        fullName: 'Laura Bianchi',   role: 'OPERATOR'  as const },
      { id: 'SEED-USER-003', email: 'marco.rinaldi@clinicos.demo',
        fullName: 'Marco Rinaldi',   role: 'OPERATOR'  as const },
      { id: 'SEED-USER-004', email: 'giulia.ferri@clinicos.demo',
        fullName: 'Giulia Ferri',    role: 'OPERATOR'  as const },
    ]
    ...
    // ── 2. Operators ──────────────────────────────────────────────────────────
    const operatorsData = [
      { id: 'SEED-OP-001', userId: 'SEED-USER-002',
        licenseNumber: 'INF-DEMO-001', department: 'Reparto A — Medicina Interna',
        phone: '+39 333 100 2001' },
      { id: 'SEED-OP-002', userId: 'SEED-USER-003',
        licenseNumber: 'OPS-DEMO-001', department: 'Reparto B — Chirurgia',
        phone: '+39 333 100 2002' },
      { id: 'SEED-OP-003', userId: 'SEED-USER-004',
        licenseNumber: 'FIS-DEMO-001', department: 'Riabilitazione',
        phone: '+39 333 100 2003' },
      { id: 'SEED-OP-004', userId: 'SEED-USER-001',
        licenseNumber: null as string | null, department: 'Amministrazione',
    ...
    for (const op of operatorsData) {
      await prisma.operator.upsert({
        ...
        create: { id: op.id, userId: op.userId, licenseNumber: op.licenseNumber,
                  department: op.department, phone: op.phone },
      })
    }
    ...
    // ── 3. Patients ───────────────────────────────────────────────────────────
    const patientsData = [
      { id: 'SEED-PAZ-001', medicalRecordNumber: 'MRN-DEMO-001',
        firstName: 'Mario',   lastName: 'Ferrioli',  dateOfBirth: dob(1948, 3, 15),
        sex: 'M', email: 'mario.ferrioli@demo.it',   phone: '+39 333 200 1001',
        address: 'Via Garibaldi 12, 20121 Milano MI',
        emergencyContactName: 'Rosa Ferrioli',        emergencyContactPhone: '+39 333 200 1002',
        registeredById: 'SEED-OP-001' },

      { id: 'SEED-PAZ-002', medicalRecordNumber: 'MRN-DEMO-002',
        firstName: 'Anna',    lastName: 'Martini',   dateOfBirth: dob(1955, 7, 22),
        sex: 'F', email: 'anna.martini@demo.it',     phone: '+39 333 200 2001',
        address: 'Corso Buenos Aires 44, 20124 Milano MI',
        emergencyContactName: 'Piero Martini',        emergencyContactPhone: '+39 333 200 2002',
        registeredById: 'SEED-OP-001' },

      { id: 'SEED-PAZ-003', medicalRecordNumber: 'MRN-DEMO-003',
        firstName: 'Giorgio', lastName: 'Bassi',     dateOfBirth: dob(1942, 11, 3),
        sex: 'M', email: 'giorgio.bassi@demo.it',    phone: '+39 333 200 3001',
        address: 'Via Roma 7, 10121 Torino TO',
        emergencyContactName: 'Carla Bassi',          emergencyContactPhone: '+39 333 200 3002',
        registeredById: 'SEED-OP-002' },

      { id: 'SEED-PAZ-004', medicalRecordNumber: 'MRN-DEMO-004',
        firstName: 'Teresa',  lastName: 'Lombardi',  dateOfBirth: dob(1961, 5, 8),
        sex: 'F', email: 'teresa.lombardi@demo.it',  phone: '+39 333 200 4001',
        address: 'Via Dante 33, 40121 Bologna BO',
        emergencyContactName: 'Franco Lombardi',      emergencyContactPhone: '+39 333 200 4002',
        registeredById: 'SEED-OP-002' },

      { id: 'SEED-PAZ-005', medicalRecordNumber: 'MRN-DEMO-005',
        firstName: 'Carlo',   lastName: 'Neri',      dateOfBirth: dob(1938, 9, 27),
        sex: 'M', email: 'carlo.neri@demo.it',       phone: '+39 333 200 5001',
        address: 'Piazza Navona 2, 00186 Roma RM',
        emergencyContactName: 'Luisa Neri',           emergencyContactPhone: '+39 333 200 5002',
        registeredById: 'SEED-OP-003' },

      { id: 'SEED-PAZ-006', medicalRecordNumber: 'MRN-DEMO-006',
        firstName: 'Lucia',   lastName: 'Gatti',     dateOfBirth: dob(1970, 2, 14),
        sex: 'F', email: 'lucia.gatti@demo.it',      phone: '+39 333 200 6001',
        address: 'Via Verdi 18, 50121 Firenze FI',
        emergencyContactName: 'Marco Gatti',          emergencyContactPhone: '+39 333 200 6002',
        registeredById: 'SEED-OP-003' },

      { id: 'SEED-PAZ-007', medicalRecordNumber: 'MRN-DEMO-007',
        firstName: 'Roberto', lastName: 'Mancini',   dateOfBirth: dob(1958, 12, 1),
        sex: 'M', email: 'roberto.mancini@demo.it',  phone: '+39 333 200 7001',
        address: 'Via Manzoni 55, 20121 Milano MI',
        emergencyContactName: 'Paola Mancini',        emergencyContactPhone: '+39 333 200 7002',
        registeredById: 'SEED-OP-001' },

      { id: 'SEED-PAZ-008', medicalRecordNumber: 'MRN-DEMO-008',
        firstName: 'Elena',   lastName: 'Moretti',   dateOfBirth: dob(1985, 6, 30),
        sex: 'F', email: 'elena.moretti@demo.it',    phone: '+39 333 200 8001',
        address: 'Via Leopardi 9, 20123 Milano MI',
        emergencyContactName: 'Stefano Moretti',      emergencyContactPhone: '+39 333 200 8002',
        registeredById: 'SEED-OP-002' },
    ]
    ...
    // ── 4. Clinical Records ───────────────────────────────────────────────────
    const recordsData = [
      { id: 'SEED-CR-001', patientId: 'SEED-PAZ-001', authorOperatorId: 'SEED-OP-001',
      ...
      { id: 'SEED-CR-002', patientId: 'SEED-PAZ-002', authorOperatorId: 'SEED-OP-001',
      ...
      { id: 'SEED-CR-003', patientId: 'SEED-PAZ-003', authorOperatorId: 'SEED-OP-002',
      ...
      { id: 'SEED-CR-004', patientId: 'SEED-PAZ-004', authorOperatorId: 'SEED-OP-002',
      ...
      { id: 'SEED-CR-005', patientId: 'SEED-PAZ-005', authorOperatorId: 'SEED-OP-003',
      ...
      { id: 'SEED-CR-006', patientId: 'SEED-PAZ-006', authorOperatorId: 'SEED-OP-003',
      ...
      { id: 'SEED-CR-007', patientId: 'SEED-PAZ-007', authorOperatorId: 'SEED-OP-001',
      ...
      { id: 'SEED-CR-008', patientId: 'SEED-PAZ-008', authorOperatorId: 'SEED-OP-002',
    ...
    for (const cr of recordsData) {
      await prisma.clinicalRecord.upsert({
        where:  { id: cr.id },
        update: { chiefComplaint: cr.chiefComplaint, diagnosis: cr.diagnosis,
    ...
    const appointmentsData = [
      { id: 'SEED-APP-001', patientId: 'SEED-PAZ-001', operatorId: 'SEED-OP-003',
        createdByUserId: 'SEED-USER-002', scheduledAt: futureDate(1, 9, 30),
        durationMinutes: 45, reason: 'Seduta fisioterapia — mobilizzazione arti inferiori',
        status: 'SCHEDULED' as const },
      { id: 'SEED-APP-002', patientId: 'SEED-PAZ-002', operatorId: 'SEED-OP-001',
        createdByUserId: 'SEED-USER-002', scheduledAt: futureDate(1, 11, 0),
        durationMinutes: 30, reason: 'Monitoraggio parametri cardiaci settimanale',
        status: 'SCHEDULED' as const },
      { id: 'SEED-APP-003', patientId: 'SEED-PAZ-003', operatorId: 'SEED-OP-003',
        createdByUserId: 'SEED-USER-003', scheduledAt: futureDate(2, 10, 0),
        durationMinutes: 60, reason: 'Fisioterapia post-operatoria — primo appoggio con deambulatore',
        status: 'SCHEDULED' as const },
      { id: 'SEED-APP-004', patientId: 'SEED-PAZ-004', operatorId: 'SEED-OP-003',
        createdByUserId: 'SEED-USER-003', scheduledAt: futureDate(2, 14, 30),
        durationMinutes: 60, reason: 'Riabilitazione neuromotoria — sessione intensiva',
        status: 'SCHEDULED' as const },
      { id: 'SEED-APP-005', patientId: 'SEED-PAZ-007', operatorId: 'SEED-OP-001',
        createdByUserId: 'SEED-USER-002', scheduledAt: futureDate(3, 8, 0),
        durationMinutes: 20, reason: 'Medicazione piede diabetico — controllo ulcera',
        status: 'SCHEDULED' as const },
    ]
